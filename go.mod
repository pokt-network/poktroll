...
replace (
	// github.com/cosmos/cosmos-sdk =>  /Users/olshansky/.asdf/installs/go/1.21.6/packages/pkg/mod/github.com/cosmos/cosmos-sdk@v0.50.5
	github.com/cosmos/cosmos-sdk => /Users/olshansky/workspace/cosmos-sdk
