...
// Upgrade_0_1_27 handles the upgrade to release `v0.1.27`.
...
var Upgrade_0_1_27 = Upgrade{
	PlanName: Upgrade_0_1_27_PlanName,
	...
	CreateUpgradeHandler: func(
		...
		setIBCParams := func(ctx context.Context) (err error) {
			...
			logger := sdkCtx.Logger().With("upgrade_plan_name", Upgrade_0_1_27_PlanName)
		...
		return func(ctx context.Context, plan upgradetypes.Plan, vm module.VersionMap) (module.VersionMap, error) {
			...
			logger := cosmostypes.UnwrapSDKContext(ctx).Logger().With("upgrade_plan_name", Upgrade_0_1_27_PlanName)
