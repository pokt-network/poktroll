...
.PHONY: query_tx_json_short
query_tx_json_short: ## Query for a transaction by hash and output as JSON.
	pocketd --home=$(POCKETD_HOME) query tx $(HASH) --output json --node $(POCKET_NODE) | jq '{code: .code, log: .raw_log, timestamp: .timestamp, height, txhash: .txhash}'
