...
params_update_tokenomics_all: ## Update the tokenomics module params
	pocketd tx authz exec ./tools/scripts/params/tokenomics_all.json $(PARAM_FLAGS)
...
params_update_tokenomics_mint_allocation_percentages: ## Update the tokenomics module mint_allocation_percentages param
	pocketd tx authz exec ./tools/scripts/params/tokenomics_mint_allocation_percentages.json $(PARAM_FLAGS)
...
params_update_tokenomics_dao_reward_address: ## Update the tokenomics module dao_reward_address param
	pocketd tx authz exec ./tools/scripts/params/tokenomics_dao_reward_address.json $(PARAM_FLAGS)
...
params_update_tokenomics_global_inflation_per_claim: ## Update the tokenomics module global_inflation_per_claim param
	pocketd tx authz exec ./tools/scripts/params/tokenomics_global_inflation_per_claim.json $(PARAM_FLAGS)
...
params_update_service_all: ## Update the service module params
	pocketd tx authz exec ./tools/scripts/params/service_all.json $(PARAM_FLAGS)
...
params_update_service_add_service_fee: ## Update the service module add_service_fee param
	pocketd tx authz exec ./tools/scripts/params/service_add_service_fee.json $(PARAM_FLAGS)
...
params_update_proof_all: ## Update the proof module params
	pocketd tx authz exec ./tools/scripts/params/proof_all.json $(PARAM_FLAGS)
...
params_update_proof_proof_request_probability: ## Update the proof module proof_request_probability param
	pocketd tx authz exec ./tools/scripts/params/proof_proof_request_probability.json $(PARAM_FLAGS)
...
params_update_proof_proof_requirement_threshold: ## Update the proof module proof_requirement_threshold param
	pocketd tx authz exec ./tools/scripts/params/proof_proof_requirement_threshold.json $(PARAM_FLAGS)
...
params_update_proof_proof_missing_penalty: ## Update the proof module proof_missing_penalty param
	pocketd tx authz exec ./tools/scripts/params/proof_proof_missing_penalty.json $(PARAM_FLAGS)
...
params_update_proof_proof_submission_fee: ## Update the proof module proof_submission_fee param
	pocketd tx authz exec ./tools/scripts/params/proof_proof_submission_fee.json $(PARAM_FLAGS)
...
params_update_shared_all: ## Update the session module params
	pocketd tx authz exec ./tools/scripts/params/shared_all.json $(PARAM_FLAGS)
...
params_update_shared_num_blocks_per_session: ## Update the shared module num_blocks_per_session param
	pocketd tx authz exec ./tools/scripts/params/shared_num_blocks_per_session.json $(PARAM_FLAGS)
...
params_update_shared_grace_period_end_offset_blocks: ## Update the shared module grace_period_end_offset_blocks param
	pocketd tx authz exec ./tools/scripts/params/shared_grace_period_end_offset_blocks.json $(PARAM_FLAGS)
...
params_update_shared_claim_window_open_offset_blocks: ## Update the shared module claim_window_open_offset_blocks param
	pocketd tx authz exec ./tools/scripts/params/shared_claim_window_open_offset_blocks.json $(PARAM_FLAGS)
...
params_update_shared_claim_window_close_offset_blocks: ## Update the shared module claim_window_close_offset_blocks param
	pocketd tx authz exec ./tools/scripts/params/shared_claim_window_close_offset_blocks.json $(PARAM_FLAGS)
...
params_update_shared_proof_window_open_offset_blocks: ## Update the shared module proof_window_open_offset_blocks param
	pocketd tx authz exec ./tools/scripts/params/shared_proof_window_open_offset_blocks.json $(PARAM_FLAGS)
...
params_update_shared_proof_window_close_offset_blocks: ## Update the shared module proof_window_close_offset_blocks param
	pocketd tx authz exec ./tools/scripts/params/shared_proof_window_close_offset_blocks.json $(PARAM_FLAGS)
...
params_update_shared_supplier_unbonding_period_sessions: ## Update the shared module supplier_unbonding_period_sessions param
	pocketd tx authz exec ./tools/scripts/params/shared_supplier_unbonding_period_sessions.json $(PARAM_FLAGS)
...
params_update_shared_application_unbonding_period_sessions: ## Update the shared module application_unbonding_period_sessions param
	pocketd tx authz exec ./tools/scripts/params/shared_application_unbonding_period_sessions.json $(PARAM_FLAGS)
...
params_update_shared_compute_units_to_tokens_multiplier: ## Update the shared module compute_units_to_tokens_multiplier param
	pocketd tx authz exec ./tools/scripts/params/shared_compute_units_to_tokens_multiplier.json $(PARAM_FLAGS)
...
params_update_shared_gateway_unbonding_period_sessions: ## Update the shared module gateway_unbonding_period_sessions param
	pocketd tx authz exec ./tools/scripts/params/shared_gateway_unbonding_period_sessions.json $(PARAM_FLAGS)
...
params_update_gateway_all: ## Update the gateway module params
	pocketd tx authz exec ./tools/scripts/params/gateway_all.json $(PARAM_FLAGS)

.PHONY: params_update_gateway_min_stake
params_update_gateway_min_stake: ## Update the gateway module min_stake param
	pocketd tx authz exec ./tools/scripts/params/gateway_min_stake.json $(PARAM_FLAGS)
...
params_update_application_all: ## Update the application module params
	pocketd tx authz exec ./tools/scripts/params/application_all.json $(PARAM_FLAGS)
...
params_update_application_max_delegated_gateways: ## Update the application module max_delegated_gateways param
	pocketd tx authz exec ./tools/scripts/params/application_max_delegated_gateways.json $(PARAM_FLAGS)
...
params_update_application_min_stake: ## Update the application module min_stake param
	pocketd tx authz exec ./tools/scripts/params/application_min_stake.json $(PARAM_FLAGS)
...
params_update_session_all: ## Update the session module params
	pocketd tx authz exec ./tools/scripts/params/session_all.json $(PARAM_FLAGS)
...
params_update_session_num_suppliers_per_session: ## Update the session module num_suppliers_per_session param
	pocketd tx authz exec ./tools/scripts/params/session_num_suppliers_per_session.json $(PARAM_FLAGS)
