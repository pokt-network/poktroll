...
The on-chain representation of an `Application` can be found at [application.proto](https://github.com/pokt-network/poktroll/tree/main/proto/poktroll/application/application.proto).
