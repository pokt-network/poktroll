...
1. A staked onchain [Application](../../4_protocol/actors/application.md) to pay for services.
2. An optional onchain [Gateway](../../4_protocol/actors/gateway.md) to optionally proxy services.
...
Please refer to the `Deploying a PATH Gateway` section in [Docker compose walkthrough](docker_compose_walkthrough.md) for detailed instructions
