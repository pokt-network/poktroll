...
See the [RelayMiner](../../4_protocol/actors/relay_miner.md) documentation for more
...
1. A staked onchain [Supplier](../../4_protocol/actors/supplier.md) to provide services.
...
Please refer to the `Deploying a RelayMiner` section in [Docker compose walkthrough](docker_compose_walkthrough.md) for detailed instructions
