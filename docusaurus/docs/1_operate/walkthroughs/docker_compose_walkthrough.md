...
## [Deprecated] Docker Compose E2E Walkthrough <!-- omit in toc -->
...
The following diagram from the [actors](../../4_protocol/actors) page captures the relationship
...
This is necessary, in particular, if you want to use [homebrew](https://brew.sh/) [to install `pocketd`](../../2_explore/user_guide/pocketd_cli.md).
...
in [this document](../../3_develop/upgrades/4_upgrade_list.md), which leads to the manual upgrade instructions.
:::
