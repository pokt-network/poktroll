...
| `tokenomics` | `claim_settlement_distribution` | `ClaimSettlementDistribution` | claim_settlement_distribution controls how the settlement amount is distributed when global inflation is disabled (global_inflation_per_claim = 0). MintEqualsBurnTLM: Only used by the MintEqualsBurnTLM at the end of claim settlement. |
