...
You can check the status of CI by looking for a run corresponding to the new release/tag on [the actions page](https://github.com/pokt-network/poktroll/releases/download/v0.1.11/release_checksum).
