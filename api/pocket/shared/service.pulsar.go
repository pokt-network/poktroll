...
var (
	md_ServiceUsageMetrics                     protoreflect.MessageDescriptor
	fd_ServiceUsageMetrics_service_id          protoreflect.FieldDescriptor
	fd_ServiceUsageMetrics_total_relays        protoreflect.FieldDescriptor
	fd_ServiceUsageMetrics_total_compute_units protoreflect.FieldDescriptor
)

func init() {
	file_pocket_shared_service_proto_init()
	md_ServiceUsageMetrics = File_pocket_shared_service_proto.Messages().ByName("ServiceUsageMetrics")
	fd_ServiceUsageMetrics_service_id = md_ServiceUsageMetrics.Fields().ByName("service_id")
	fd_ServiceUsageMetrics_total_relays = md_ServiceUsageMetrics.Fields().ByName("total_relays")
	fd_ServiceUsageMetrics_total_compute_units = md_ServiceUsageMetrics.Fields().ByName("total_compute_units")
}

var _ protoreflect.Message = (*fastReflection_ServiceUsageMetrics)(nil)

type fastReflection_ServiceUsageMetrics ServiceUsageMetrics

func (x *ServiceUsageMetrics) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ServiceUsageMetrics)(x)
}

func (x *ServiceUsageMetrics) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_shared_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_ServiceUsageMetrics_messageType fastReflection_ServiceUsageMetrics_messageType
var _ protoreflect.MessageType = fastReflection_ServiceUsageMetrics_messageType{}

type fastReflection_ServiceUsageMetrics_messageType struct{}

func (x fastReflection_ServiceUsageMetrics_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ServiceUsageMetrics)(nil)
}
func (x fastReflection_ServiceUsageMetrics_messageType) New() protoreflect.Message {
	return new(fastReflection_ServiceUsageMetrics)
}
func (x fastReflection_ServiceUsageMetrics_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ServiceUsageMetrics
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ServiceUsageMetrics) Descriptor() protoreflect.MessageDescriptor {
	return md_ServiceUsageMetrics
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ServiceUsageMetrics) Type() protoreflect.MessageType {
	return _fastReflection_ServiceUsageMetrics_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ServiceUsageMetrics) New() protoreflect.Message {
	return new(fastReflection_ServiceUsageMetrics)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ServiceUsageMetrics) Interface() protoreflect.ProtoMessage {
	return (*ServiceUsageMetrics)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ServiceUsageMetrics) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ServiceId != "" {
		value := protoreflect.ValueOfString(x.ServiceId)
		if !f(fd_ServiceUsageMetrics_service_id, value) {
			return
		}
	}
	if x.TotalRelays != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalRelays)
		if !f(fd_ServiceUsageMetrics_total_relays, value) {
			return
		}
	}
	if x.TotalComputeUnits != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalComputeUnits)
		if !f(fd_ServiceUsageMetrics_total_compute_units, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ServiceUsageMetrics) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		return x.ServiceId != ""
	case "pocket.shared.ServiceUsageMetrics.total_relays":
		return x.TotalRelays != uint64(0)
	case "pocket.shared.ServiceUsageMetrics.total_compute_units":
		return x.TotalComputeUnits != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.shared.ServiceUsageMetrics"))
		}
		panic(fmt.Errorf("message pocket.shared.ServiceUsageMetrics does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ServiceUsageMetrics) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		x.ServiceId = ""
	case "pocket.shared.ServiceUsageMetrics.total_relays":
		x.TotalRelays = uint64(0)
	case "pocket.shared.ServiceUsageMetrics.total_compute_units":
		x.TotalComputeUnits = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.shared.ServiceUsageMetrics"))
		}
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ServiceUsageMetrics) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		value := x.ServiceId
		return protoreflect.ValueOfString(value)
	case "pocket.shared.ServiceUsageMetrics.total_relays":
		...
		return protoreflect.ValueOfUint64(value)
	case "pocket.shared.ServiceUsageMetrics.total_compute_units":
		value := x.TotalComputeUnits
		return protoreflect.ValueOfUint64(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.shared.ServiceUsageMetrics"))
		}
		panic(fmt.Errorf("message pocket.shared.ServiceUsageMetrics does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ServiceUsageMetrics) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		x.ServiceId = value.Interface().(string)
	case "pocket.shared.ServiceUsageMetrics.total_relays":
		x.TotalRelays = value.Uint()
	case "pocket.shared.ServiceUsageMetrics.total_compute_units":
		x.TotalComputeUnits = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.shared.ServiceUsageMetrics"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ServiceUsageMetrics) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		panic(fmt.Errorf("field service_id of message pocket.shared.ServiceUsageMetrics is not mutable"))
	case "pocket.shared.ServiceUsageMetrics.total_relays":
		panic(fmt.Errorf("field total_relays of message pocket.shared.ServiceUsageMetrics is not mutable"))
	case "pocket.shared.ServiceUsageMetrics.total_compute_units":
		panic(fmt.Errorf("field total_compute_units of message pocket.shared.ServiceUsageMetrics is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.shared.ServiceUsageMetrics"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ServiceUsageMetrics) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pocket.shared.ServiceUsageMetrics.service_id":
		return protoreflect.ValueOfString("")
	case "pocket.shared.ServiceUsageMetrics.total_relays":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ServiceUsageMetrics) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.shared.ServiceUsageMetrics", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ServiceUsageMetrics) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ServiceUsageMetrics) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ServiceUsageMetrics) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ServiceUsageMetrics) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ServiceUsageMetrics)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		if x.TotalRelays != 0 {
			n += 1 + runtime.Sov(uint64(x.TotalRelays))
		}
		if x.TotalComputeUnits != 0 {
			n += 1 + runtime.Sov(uint64(x.TotalComputeUnits))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TotalComputeUnits != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TotalComputeUnits))
			i--
			dAtA[i] = 0x18
		}
		if x.TotalRelays != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.TotalRelays))
			i--
			dAtA[i] = 0x10
		}
		if len(x.ServiceId) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ServiceUsageMetrics: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ServiceUsageMetrics: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalRelays", wireType)
				}
				x.TotalRelays = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TotalRelays |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalComputeUnits", wireType)
				}
				x.TotalComputeUnits = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.TotalComputeUnits |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *ServiceUsageMetrics) Reset() {
	*x = ServiceUsageMetrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pocket_shared_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ServiceUsageMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServiceUsageMetrics) ProtoMessage() {}

// Deprecated: Use ServiceUsageMetrics.ProtoReflect.Descriptor instead.
func (*ServiceUsageMetrics) Descriptor() ([]byte, []int) {
	return file_pocket_shared_service_proto_rawDescGZIP(), []int{6}
}

func (x *ServiceUsageMetrics) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *ServiceUsageMetrics) GetTotalRelays() uint64 {
	if x != nil {
		return x.TotalRelays
	}
	return 0
}

func (x *ServiceUsageMetrics) GetTotalComputeUnits() uint64 {
	if x != nil {
...
var file_pocket_shared_service_proto_rawDesc = []byte{
	...
	,
	...
	0x68, 0x61, 0x72, 0x65, 0x64, 0xa2, 0x02, 0x03, 0x50, 0x53, 0x58, 0xaa, 0x02, 0x0d, 0x50, 0x6f,
	0x63, 0x6b, 0x65, 0x74, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0xca, 0x02, 0x0d, 0x50, 0x6f,
	0x63, 0x6b, 0x65, 0x74, 0x5c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0xe2, 0x02, 0x19, 0x50, 0x6f,
	0x63, 0x6b, 0x65, 0x74, 0x5c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5c, 0x47, 0x50, 0x42, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x50, 0x6f, 0x63, 0x6b, 0x65, 0x74,
...
var file_pocket_shared_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pocket_shared_service_proto_goTypes = []interface{}{
	...
	(*ServiceUsageMetrics)(nil),      // 8: pocket.shared.ServiceUsageMetrics
}
...
func file_pocket_shared_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pocket_shared_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServiceUsageMetrics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
