...
const (
	...
	Query_ParamsUpdates_FullMethodName            = "/pocket.service.Query/ParamsUpdates"
	...
	Query_RelayMiningDifficultyAll_FullMethodName = "/pocket.service.Query/RelayMiningDifficultyAll"
)
...
func (c *queryClient) AllServices(ctx context.Context, in *QueryAllServicesRequest, opts ...grpc.CallOption) (*QueryAllServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AllServices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
