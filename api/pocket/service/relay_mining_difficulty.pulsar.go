...
func init() {
	...
	md_RelayMiningDifficulty = File_pocket_service_relay_mining_difficulty_proto.Messages().ByName("RelayMiningDifficulty")
...
func (x *RelayMiningDifficulty) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_service_relay_mining_difficulty_proto_msgTypes[0]
...
func (x *fastReflection_RelayMiningDifficulty) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.service.RelayMiningDifficulty.service_id":
		return x.ServiceId != ""
	case "pocket.service.RelayMiningDifficulty.block_height":
		return x.BlockHeight != int64(0)
	case "pocket.service.RelayMiningDifficulty.num_relays_ema":
		return x.NumRelaysEma != uint64(0)
	case "pocket.service.RelayMiningDifficulty.target_hash":
		return len(x.TargetHash) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.service.RelayMiningDifficulty"))
		}
		panic(fmt.Errorf("message pocket.service.RelayMiningDifficulty does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_RelayMiningDifficulty) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.service.RelayMiningDifficulty does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_RelayMiningDifficulty) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pocket.service.RelayMiningDifficulty.service_id":
		panic(fmt.Errorf("field service_id of message pocket.service.RelayMiningDifficulty is not mutable"))
	case "pocket.service.RelayMiningDifficulty.block_height":
		panic(fmt.Errorf("field block_height of message pocket.service.RelayMiningDifficulty is not mutable"))
	case "pocket.service.RelayMiningDifficulty.num_relays_ema":
		panic(fmt.Errorf("field num_relays_ema of message pocket.service.RelayMiningDifficulty is not mutable"))
	case "pocket.service.RelayMiningDifficulty.target_hash":
		panic(fmt.Errorf("field target_hash of message pocket.service.RelayMiningDifficulty is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.service.RelayMiningDifficulty"))
		}
...
func (x *fastReflection_RelayMiningDifficulty) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.service.RelayMiningDifficulty", d.FullName()))
	}
	panic("unreachable")
}
...
func (*RelayMiningDifficulty) Descriptor() ([]byte, []int) {
	return file_pocket_service_relay_mining_difficulty_proto_rawDescGZIP(), []int{0}
}
...
var File_pocket_service_relay_mining_difficulty_proto protoreflect.FileDescriptor

var file_pocket_service_relay_mining_difficulty_proto_rawDesc = []byte{
	0x0a, 0x2c, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2f, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x5f, 0x6d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x64, 0x69,
	0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e,
	0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x1a, 0x14,
	0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x4d, 0x69,
	0x6e, 0x69, 0x6e, 0x67, 0x44, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x12, 0x1d,
	...
	,
...
var (
	file_pocket_service_relay_mining_difficulty_proto_rawDescOnce sync.Once
	file_pocket_service_relay_mining_difficulty_proto_rawDescData = file_pocket_service_relay_mining_difficulty_proto_rawDesc
)

func file_pocket_service_relay_mining_difficulty_proto_rawDescGZIP() []byte {
	file_pocket_service_relay_mining_difficulty_proto_rawDescOnce.Do(func() {
		file_pocket_service_relay_mining_difficulty_proto_rawDescData = protoimpl.X.CompressGZIP(file_pocket_service_relay_mining_difficulty_proto_rawDescData)
	})
	return file_pocket_service_relay_mining_difficulty_proto_rawDescData
}

var file_pocket_service_relay_mining_difficulty_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pocket_service_relay_mining_difficulty_proto_goTypes = []interface{}{
	(*RelayMiningDifficulty)(nil), // 0: pocket.service.RelayMiningDifficulty
}
var file_pocket_service_relay_mining_difficulty_proto_depIdxs = []int32{
...
func init() { file_pocket_service_relay_mining_difficulty_proto_init() }
func file_pocket_service_relay_mining_difficulty_proto_init() {
	if File_pocket_service_relay_mining_difficulty_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pocket_service_relay_mining_difficulty_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pocket_service_relay_mining_difficulty_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pocket_service_relay_mining_difficulty_proto_goTypes,
		DependencyIndexes: file_pocket_service_relay_mining_difficulty_proto_depIdxs,
		MessageInfos:      file_pocket_service_relay_mining_difficulty_proto_msgTypes,
	}.Build()
	File_pocket_service_relay_mining_difficulty_proto = out.File
	file_pocket_service_relay_mining_difficulty_proto_rawDesc = nil
	file_pocket_service_relay_mining_difficulty_proto_goTypes = nil
	file_pocket_service_relay_mining_difficulty_proto_depIdxs = nil
}
