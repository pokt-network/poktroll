...
func init() {
	file_pocket_service_event_proto_init()
	md_EventParamsUpdated = File_pocket_service_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.service.EventParamsUpdated.params":
		return x.Params != nil
	case "pocket.service.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.service.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message pocket.service.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.service.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.service.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message pocket.service.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.service.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.service.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
var file_pocket_service_event_proto_rawDesc = []byte{
	...
	0x61, 0x22, 0xab, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x43, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61,
	...
	0x42, 0x13, 0xc8, 0xde, 0x1f, 0x00, 0xea, 0xde, 0x1f, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42, 0x1a, 0xea,
	0xde, 0x1f, 0x16, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x14, 0x65, 0x66, 0x66, 0x65, 0x63,
	...
	0x65, 0x74, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x1f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
...
var file_pocket_service_event_proto_goTypes = []interface{}{
	...
	(*EventParamsUpdated)(nil),                // 1: pocket.service.EventParamsUpdated
	(*Params)(nil),                            // 2: pocket.service.Params
}
var file_pocket_service_event_proto_depIdxs = []int32{
	2, // 0: pocket.service.EventParamsUpdated.params:type_name -> pocket.service.Params
