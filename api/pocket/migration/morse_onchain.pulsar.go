...
func (x *fastReflection_MorseClaimableAccount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.MorseOutputAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.MorseOutputAddress)
...
func (x *fastReflection_MorseClaimableAccount) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "pocket.migration.MorseClaimableAccount.morse_output_address":
		return len(x.MorseOutputAddress) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MorseClaimableAccount) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "pocket.migration.MorseClaimableAccount.morse_output_address":
		x.MorseOutputAddress = value.Bytes()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.migration.MorseClaimableAccount"))
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				...
				x.MorseOutputAddress = append(x.MorseOutputAddress[:0], dAtA[iNdEx:postIndex]...)
				if x.MorseOutputAddress == nil {
					x.MorseOutputAddress = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type MorseClaimableAccount struct {
	...
	MorseOutputAddress []byte `protobuf:"bytes,9,opt,name=morse_output_address,json=morseOutputAddress,proto3" json:"morse_output_address,omitempty"`
}
...
func (x *MorseClaimableAccount) GetMorseOutputAddress() []byte {
	if x != nil {
...
var file_pocket_migration_morse_onchain_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x73, 0x22, 0xed, 0x05, 0x0a, 0x15, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x43, 0x6c,
	...
	0x64, 0x41, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0xa2, 0x01, 0x0a, 0x14, 0x6d, 0x6f,
	0x72, 0x73, 0x65, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x70, 0xea, 0xde, 0x1f, 0x1e, 0x6d, 0x6f,
	0x72, 0x73, 0x65, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	...
	0x75, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xfa, 0xde, 0x1f, 0x2b, 0x67,
	...
	0x74, 0x6f, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x12, 0x6d, 0x6f, 0x72, 0x73,
