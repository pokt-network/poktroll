...
var (
	...
	fd_MorseValidator_OutputAddress protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MorseValidator_OutputAddress = md_MorseValidator.Fields().ByName("OutputAddress")
}
...
func (x *fastReflection_MorseValidator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.OutputAddress) != 0 {
		...
		if !f(fd_MorseValidator_OutputAddress, value) {
			return
		}
	}
}
...
func (x *fastReflection_MorseValidator) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "pocket.migration.MorseValidator.staked_tokens":
		return x.StakedTokens != ""
	case "pocket.migration.MorseValidator.OutputAddress":
...
func (x *fastReflection_MorseValidator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.migration.MorseValidator.OutputAddress":
		panic(fmt.Errorf("field OutputAddress of message pocket.migration.MorseValidator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.migration.MorseValidator"))
		}
...
type MorseValidator struct {
	...
	OutputAddress []byte `protobuf:"bytes,9,opt,name=OutputAddress,proto3" json:"OutputAddress,omitempty"`
}
...
var file_pocket_migration_morse_offchain_proto_rawDesc = []byte{
	...
	0x00, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xd0, 0x03, 0x0a, 0x0e, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x56,
	...
	,
	...
	0x5e, 0x0a, 0x07, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x20, 0x2e, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b,
	0x65, 0x79, 0x42, 0x23, 0xea, 0xde, 0x1f, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b,
	...
	,
