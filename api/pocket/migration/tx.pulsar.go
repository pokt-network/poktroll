...
var (
	...
	fd_MsgClaimMorseSupplier_morse_signer_public_key  protoreflect.FieldDescriptor
	fd_MsgClaimMorseSupplier_morse_operator_address   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgClaimMorseSupplier_morse_signer_public_key = md_MsgClaimMorseSupplier.Fields().ByName("morse_signer_public_key")
	fd_MsgClaimMorseSupplier_morse_operator_address = md_MsgClaimMorseSupplier.Fields().ByName("morse_operator_address")
...
func (x *fastReflection_MsgClaimMorseSupplier) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.MorseSignerPublicKey) != 0 {
		value := protoreflect.ValueOfBytes(x.MorseSignerPublicKey)
		if !f(fd_MsgClaimMorseSupplier_morse_signer_public_key, value) {
			return
		}
	}
	if x.MorseOperatorAddress != "" {
		value := protoreflect.ValueOfString(x.MorseOperatorAddress)
		if !f(fd_MsgClaimMorseSupplier_morse_operator_address, value) {
			return
		}
	}
	if len(x.MorseSignature) != 0 {
...
func (x *fastReflection_MsgClaimMorseSupplier) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "pocket.migration.MsgClaimMorseSupplier.morse_signer_public_key":
		return len(x.MorseSignerPublicKey) != 0
	case "pocket.migration.MsgClaimMorseSupplier.morse_operator_address":
...
func (x *fastReflection_MsgClaimMorseSupplier) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "pocket.migration.MsgClaimMorseSupplier.morse_signer_public_key":
		x.MorseSignerPublicKey = value.Bytes()
	case "pocket.migration.MsgClaimMorseSupplier.morse_operator_address":
...
func (x *fastReflection_MsgClaimMorseSupplier) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.migration.MsgClaimMorseSupplier.morse_signer_public_key":
		panic(fmt.Errorf("field morse_signer_public_key of message pocket.migration.MsgClaimMorseSupplier is not mutable"))
	case "pocket.migration.MsgClaimMorseSupplier.morse_operator_address":
		panic(fmt.Errorf("field morse_operator_address of message pocket.migration.MsgClaimMorseSupplier is not mutable"))
	case "pocket.migration.MsgClaimMorseSupplier.morse_signature":
...
func (x *fastReflection_MsgClaimMorseSupplier) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.MorseSignerPublicKey) > 0 {
			i -= len(x.MorseSignerPublicKey)
			copy(dAtA[i:], x.MorseSignerPublicKey)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MorseSignerPublicKey)))
			i--
			dAtA[i] = 0x3a
		}
		if len(x.ShannonSigningAddress) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MorseSignerPublicKey", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.MorseSignerPublicKey = append(x.MorseSignerPublicKey[:0], dAtA[iNdEx:postIndex]...)
				if x.MorseSignerPublicKey == nil {
					x.MorseSignerPublicKey = []byte{}
				}
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
var (
	...
	fd_MsgClaimMorseSupplierResponse_morse_operator_address protoreflect.FieldDescriptor
	fd_MsgClaimMorseSupplierResponse_morse_singer_address   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgClaimMorseSupplierResponse_morse_operator_address = md_MsgClaimMorseSupplierResponse.Fields().ByName("morse_operator_address")
	fd_MsgClaimMorseSupplierResponse_morse_singer_address = md_MsgClaimMorseSupplierResponse.Fields().ByName("morse_singer_address")
...
func (x *fastReflection_MsgClaimMorseSupplierResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MorseOperatorAddress != "" {
		value := protoreflect.ValueOfString(x.MorseOperatorAddress)
		if !f(fd_MsgClaimMorseSupplierResponse_morse_operator_address, value) {
			return
		}
	}
	if x.MorseSingerAddress != "" {
		value := protoreflect.ValueOfString(x.MorseSingerAddress)
		if !f(fd_MsgClaimMorseSupplierResponse_morse_singer_address, value) {
			return
		}
	}
...
func (x *fastReflection_MsgClaimMorseSupplierResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.migration.MsgClaimMorseSupplierResponse.morse_operator_address":
		return x.MorseOperatorAddress != ""
	case "pocket.migration.MsgClaimMorseSupplierResponse.morse_singer_address":
...
func (x *fastReflection_MsgClaimMorseSupplierResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.migration.MsgClaimMorseSupplierResponse.morse_operator_address":
		panic(fmt.Errorf("field morse_operator_address of message pocket.migration.MsgClaimMorseSupplierResponse is not mutable"))
	case "pocket.migration.MsgClaimMorseSupplierResponse.morse_singer_address":
		panic(fmt.Errorf("field morse_singer_address of message pocket.migration.MsgClaimMorseSupplierResponse is not mutable"))
	case "pocket.migration.MsgClaimMorseSupplierResponse.claim_signer_type":
...
type MsgClaimMorseSupplier struct {
	...
	// If the node/supplier is non-custodial the owner/output account MUST be claimed PRIOR TO
	// claiming ANY corresponding Morse nodes/suppliers.
	MorseSignerPublicKey []byte `protobuf:"bytes,7,opt,name=morse_signer_public_key,json=morseSignerPublicKey,proto3" json:"morse_signer_public_key,omitempty"`
	// TODO_IN_THIS_COMMIT: update...
	// The hex-encoded address of the Morse account whose balance will be claimed.
	// E.g.: 00f9900606fa3d5c9179fc0c8513078a53a2073e
	...
	// The hex-encoded signature, by the Morse account, of this message (where this field is nil).
	// I.e.: morse_signature = private_key.sign(marshal(MsgClaimMorseAccount{morse_signature: nil, ...}))
	// The signature of EITHER the Morse supplier operator OR owner account, matching the public key used.
...
func (x *MsgClaimMorseSupplier) GetMorseSignerPublicKey() []byte {
	if x != nil {
		return x.MorseSignerPublicKey
	}
	return nil
}

func (x *MsgClaimMorseSupplier) GetMorseOperatorAddress() string {
	if x != nil {
		return x.MorseOperatorAddress
	}
	return ""
...
type MsgClaimMorseSupplierResponse struct {
	...
	// TODO_IN_THIS_COMMIT: rename to morse_operator_address...
	// The hex-encoded address of the Morse account whose balance was claimed.
	// E.g.: 00f9900606fa3d5c9179fc0c8513078a53a2073e
	MorseOperatorAddress string `protobuf:"bytes,1,opt,name=morse_operator_address,json=morseOperatorAddress,proto3" json:"morse_operator_address,omitempty"`
	// TODO_IN_THIS_COMMIT: update...
	// TODO_IN_THIS_COMMIT: use in msg handler!
	MorseSingerAddress string `protobuf:"bytes,8,opt,name=morse_singer_address,json=morseSingerAddress,proto3" json:"morse_singer_address,omitempty"`
...
func (x *MsgClaimMorseSupplierResponse) GetMorseOperatorAddress() string {
	if x != nil {
		return x.MorseOperatorAddress
	}
	return ""
...
func (x *MsgClaimMorseSupplierResponse) GetMorseSingerAddress() string {
	if x != nil {
		return x.MorseSingerAddress
	}
	return ""
...
var file_pocket_migration_tx_proto_rawDesc = []byte{
	...
	0x0b, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe4, 0x05, 0x0a,
	...
	,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x4e, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	,
	...
	,
	...
	0x6e, 0x45, 0x6e, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x41, 0x0a, 0x08, 0x73, 0x75,
	0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70,
	...
	0x69, 0x65, 0x72, 0x52, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x22, 0x94, 0x02,
