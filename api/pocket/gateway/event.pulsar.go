...
func init() {
	file_pocket_gateway_event_proto_init()
	md_EventParamsUpdated = File_pocket_gateway_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.gateway.EventParamsUpdated.params":
		return x.Params != nil
	case "pocket.gateway.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.gateway.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message pocket.gateway.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.gateway.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.gateway.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message pocket.gateway.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.gateway.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.gateway.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
var file_pocket_gateway_event_proto_rawDesc = []byte{
	...
	0x1f, 0x12, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x6e, 0x64, 0x5f, 0x68, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x52, 0x10, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x64,
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xab, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x43, 0x0a,
	...
	0x69, 0x67, 0x68, 0x74, 0x42, 0x9e, 0x01, 0xd8, 0xe2, 0x1e, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d,
	0x2e, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x42,
	0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x1f, 0x63,
...
var file_pocket_gateway_event_proto_goTypes = []interface{}{
	...
	(*EventParamsUpdated)(nil),            // 4: pocket.gateway.EventParamsUpdated
...
var file_pocket_gateway_event_proto_depIdxs = []int32{
	...
	6, // 4: pocket.gateway.EventParamsUpdated.params:type_name -> pocket.gateway.Params
