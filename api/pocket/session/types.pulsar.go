...
func init() {
	...
	md_SessionHeader = File_pocket_session_types_proto.Messages().ByName("SessionHeader")
...
func (x *SessionHeader) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_session_types_proto_msgTypes[0]
...
func (x *fastReflection_SessionHeader) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.session.SessionHeader.application_address":
		return x.ApplicationAddress != ""
	case "pocket.session.SessionHeader.service_id":
		return x.ServiceId != ""
	case "pocket.session.SessionHeader.session_id":
		return x.SessionId != ""
	case "pocket.session.SessionHeader.session_start_block_height":
		return x.SessionStartBlockHeight != int64(0)
	case "pocket.session.SessionHeader.session_end_block_height":
		return x.SessionEndBlockHeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.session.SessionHeader"))
		}
		panic(fmt.Errorf("message pocket.session.SessionHeader does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SessionHeader) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.session.SessionHeader does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SessionHeader) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pocket.session.SessionHeader.application_address":
		panic(fmt.Errorf("field application_address of message pocket.session.SessionHeader is not mutable"))
	case "pocket.session.SessionHeader.service_id":
		panic(fmt.Errorf("field service_id of message pocket.session.SessionHeader is not mutable"))
	case "pocket.session.SessionHeader.session_id":
		panic(fmt.Errorf("field session_id of message pocket.session.SessionHeader is not mutable"))
	case "pocket.session.SessionHeader.session_start_block_height":
		panic(fmt.Errorf("field session_start_block_height of message pocket.session.SessionHeader is not mutable"))
	case "pocket.session.SessionHeader.session_end_block_height":
		panic(fmt.Errorf("field session_end_block_height of message pocket.session.SessionHeader is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.session.SessionHeader"))
		}
...
func (x *fastReflection_SessionHeader) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.session.SessionHeader", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_session_types_proto_init()
	md_Session = File_pocket_session_types_proto.Messages().ByName("Session")
...
func (x *Session) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_session_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Session) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.session.Session.header":
		return x.Header != nil
	case "pocket.session.Session.session_id":
		return x.SessionId != ""
	case "pocket.session.Session.session_number":
		return x.SessionNumber != int64(0)
	case "pocket.session.Session.num_blocks_per_session":
		return x.NumBlocksPerSession != int64(0)
	case "pocket.session.Session.application":
		return x.Application != nil
	case "pocket.session.Session.suppliers":
		return len(x.Suppliers) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.session.Session"))
		}
		panic(fmt.Errorf("message pocket.session.Session does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Session) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.session.Session does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Session) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.session.Session.session_id":
		panic(fmt.Errorf("field session_id of message pocket.session.Session is not mutable"))
	case "pocket.session.Session.session_number":
		panic(fmt.Errorf("field session_number of message pocket.session.Session is not mutable"))
	case "pocket.session.Session.num_blocks_per_session":
		panic(fmt.Errorf("field num_blocks_per_session of message pocket.session.Session is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.session.Session"))
		}
...
func (x *fastReflection_Session) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.session.Session", d.FullName()))
	}
	panic("unreachable")
}
...
func (*SessionHeader) Descriptor() ([]byte, []int) {
	return file_pocket_session_types_proto_rawDescGZIP(), []int{0}
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_pocket_session_types_proto_rawDescGZIP(), []int{1}
}
...
var File_pocket_session_types_proto protoreflect.FileDescriptor

var file_pocket_session_types_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x65, 0x74, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x19, 0x63, 0x6f,
	...
	0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x02, 0x0a, 0x0d, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x13, 0x61, 0x70,
	...
	,
	...
	0x01, 0x28, 0x03, 0x52, 0x0d, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x12, 0x33, 0x0a, 0x16, 0x6e, 0x75, 0x6d, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73,
	0x5f, 0x70, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x13, 0x6e, 0x75, 0x6d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x50, 0x65, 0x72,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x41, 0x0a, 0x0b, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x70,
	...
	0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x09, 0x73, 0x75,
	0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	,
}

var (
	file_pocket_session_types_proto_rawDescOnce sync.Once
	file_pocket_session_types_proto_rawDescData = file_pocket_session_types_proto_rawDesc
)

func file_pocket_session_types_proto_rawDescGZIP() []byte {
	file_pocket_session_types_proto_rawDescOnce.Do(func() {
		file_pocket_session_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_pocket_session_types_proto_rawDescData)
	})
	return file_pocket_session_types_proto_rawDescData
}

var file_pocket_session_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pocket_session_types_proto_goTypes = []interface{}{
	(*SessionHeader)(nil),           // 0: pocket.session.SessionHeader
	(*Session)(nil),                 // 1: pocket.session.Session
	(*application.Application)(nil), // 2: pocket.application.Application
	(*shared.Supplier)(nil),         // 3: pocket.shared.Supplier
}
var file_pocket_session_types_proto_depIdxs = []int32{
	0, // 0: pocket.session.Session.header:type_name -> pocket.session.SessionHeader
	2, // 1: pocket.session.Session.application:type_name -> pocket.application.Application
	3, // 2: pocket.session.Session.suppliers:type_name -> pocket.shared.Supplier
...
func init() { file_pocket_session_types_proto_init() }
func file_pocket_session_types_proto_init() {
	if File_pocket_session_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pocket_session_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_session_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pocket_session_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pocket_session_types_proto_goTypes,
		DependencyIndexes: file_pocket_session_types_proto_depIdxs,
		MessageInfos:      file_pocket_session_types_proto_msgTypes,
	}.Build()
	File_pocket_session_types_proto = out.File
	file_pocket_session_types_proto_rawDesc = nil
	file_pocket_session_types_proto_goTypes = nil
	file_pocket_session_types_proto_depIdxs = nil
}
