...
const (
	Msg_UpdateParams_FullMethodName    = "/pocket.supplier.Msg/UpdateParams"
	Msg_StakeSupplier_FullMethodName   = "/pocket.supplier.Msg/StakeSupplier"
	Msg_UnstakeSupplier_FullMethodName = "/pocket.supplier.Msg/UnstakeSupplier"
	Msg_UpdateParam_FullMethodName     = "/pocket.supplier.Msg/UpdateParam"
)
...
func (c *msgClient) StakeSupplier(ctx context.Context, in *MsgStakeSupplier, opts ...grpc.CallOption) (*MsgStakeSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_StakeSupplier_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UnstakeSupplier(ctx context.Context, in *MsgUnstakeSupplier, opts ...grpc.CallOption) (*MsgUnstakeSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UnstakeSupplier_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) StakeSupplier(context.Context, *MsgStakeSupplier) (*MsgStakeSupplierResponse, error) {
...
func _Msg_StakeSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_StakeSupplier_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UnstakeSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UnstakeSupplier_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
