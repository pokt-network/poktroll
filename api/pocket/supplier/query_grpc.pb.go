...
const (
	Query_Params_FullMethodName         = "/pocket.supplier.Query/Params"
	Query_ParamsAtHeight_FullMethodName = "/pocket.supplier.Query/ParamsAtHeight"
	Query_ParamsUpdates_FullMethodName  = "/pocket.supplier.Query/ParamsUpdates"
	Query_Supplier_FullMethodName       = "/pocket.supplier.Query/Supplier"
	Query_AllSuppliers_FullMethodName   = "/pocket.supplier.Query/AllSuppliers"
)
...
func (c *queryClient) Supplier(ctx context.Context, in *QueryGetSupplierRequest, opts ...grpc.CallOption) (*QueryGetSupplierResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Supplier_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllSuppliers(ctx context.Context, in *QueryAllSuppliersRequest, opts ...grpc.CallOption) (*QueryAllSuppliersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_AllSuppliers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
