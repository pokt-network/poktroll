...
func init() {
	...
	md_ClaimSettlementResult = File_pocket_tokenomics_types_proto.Messages().ByName("ClaimSettlementResult")
...
func (x *ClaimSettlementResult) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_tokenomics_types_proto_msgTypes[0]
...
func (x *fastReflection_ClaimSettlementResult) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.tokenomics.ClaimSettlementResult.claim":
		return x.Claim != nil
	case "pocket.tokenomics.ClaimSettlementResult.mints":
		return len(x.Mints) != 0
	case "pocket.tokenomics.ClaimSettlementResult.burns":
		return len(x.Burns) != 0
	case "pocket.tokenomics.ClaimSettlementResult.mod_to_mod_transfers":
		return len(x.ModToModTransfers) != 0
	case "pocket.tokenomics.ClaimSettlementResult.mod_to_acct_transfers":
		return len(x.ModToAcctTransfers) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.ClaimSettlementResult"))
		}
		panic(fmt.Errorf("message pocket.tokenomics.ClaimSettlementResult does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ClaimSettlementResult) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.tokenomics.ClaimSettlementResult does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ClaimSettlementResult) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.tokenomics.ClaimSettlementResult", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_tokenomics_types_proto_init()
	md_MintBurnOp = File_pocket_tokenomics_types_proto.Messages().ByName("MintBurnOp")
...
func (x *MintBurnOp) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_tokenomics_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MintBurnOp) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.tokenomics.MintBurnOp.op_reason":
		return x.OpReason != 0
	case "pocket.tokenomics.MintBurnOp.DestinationModule":
		return x.DestinationModule != ""
	case "pocket.tokenomics.MintBurnOp.coin":
		return x.Coin != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.MintBurnOp"))
		}
		panic(fmt.Errorf("message pocket.tokenomics.MintBurnOp does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MintBurnOp) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.tokenomics.MintBurnOp does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MintBurnOp) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.tokenomics.MintBurnOp.op_reason":
		panic(fmt.Errorf("field op_reason of message pocket.tokenomics.MintBurnOp is not mutable"))
	case "pocket.tokenomics.MintBurnOp.DestinationModule":
		panic(fmt.Errorf("field DestinationModule of message pocket.tokenomics.MintBurnOp is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.MintBurnOp"))
		}
...
func (x *fastReflection_MintBurnOp) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.tokenomics.MintBurnOp", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_tokenomics_types_proto_init()
	md_ModToAcctTransfer = File_pocket_tokenomics_types_proto.Messages().ByName("ModToAcctTransfer")
...
func (x *ModToAcctTransfer) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_tokenomics_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ModToAcctTransfer) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.tokenomics.ModToAcctTransfer.op_reason":
		return x.OpReason != 0
	case "pocket.tokenomics.ModToAcctTransfer.SenderModule":
		return x.SenderModule != ""
	case "pocket.tokenomics.ModToAcctTransfer.RecipientAddress":
		return x.RecipientAddress != ""
	case "pocket.tokenomics.ModToAcctTransfer.coin":
		return x.Coin != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.ModToAcctTransfer"))
		}
		panic(fmt.Errorf("message pocket.tokenomics.ModToAcctTransfer does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModToAcctTransfer) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.tokenomics.ModToAcctTransfer does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModToAcctTransfer) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.tokenomics.ModToAcctTransfer.coin":
		...
		return protoreflect.ValueOfMessage(x.Coin.ProtoReflect())
	case "pocket.tokenomics.ModToAcctTransfer.op_reason":
		panic(fmt.Errorf("field op_reason of message pocket.tokenomics.ModToAcctTransfer is not mutable"))
	case "pocket.tokenomics.ModToAcctTransfer.SenderModule":
		panic(fmt.Errorf("field SenderModule of message pocket.tokenomics.ModToAcctTransfer is not mutable"))
	case "pocket.tokenomics.ModToAcctTransfer.RecipientAddress":
		panic(fmt.Errorf("field RecipientAddress of message pocket.tokenomics.ModToAcctTransfer is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.ModToAcctTransfer"))
		}
...
func (x *fastReflection_ModToAcctTransfer) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.tokenomics.ModToAcctTransfer", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_tokenomics_types_proto_init()
	md_ModToModTransfer = File_pocket_tokenomics_types_proto.Messages().ByName("ModToModTransfer")
...
func (x *ModToModTransfer) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_tokenomics_types_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ModToModTransfer) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.tokenomics.ModToModTransfer.op_reason":
		return x.OpReason != 0
	case "pocket.tokenomics.ModToModTransfer.SenderModule":
		return x.SenderModule != ""
	case "pocket.tokenomics.ModToModTransfer.RecipientModule":
		return x.RecipientModule != ""
	case "pocket.tokenomics.ModToModTransfer.coin":
		return x.Coin != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.ModToModTransfer"))
		}
		panic(fmt.Errorf("message pocket.tokenomics.ModToModTransfer does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModToModTransfer) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.tokenomics.ModToModTransfer does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModToModTransfer) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.tokenomics.ModToModTransfer.coin":
		...
		return protoreflect.ValueOfMessage(x.Coin.ProtoReflect())
	case "pocket.tokenomics.ModToModTransfer.op_reason":
		panic(fmt.Errorf("field op_reason of message pocket.tokenomics.ModToModTransfer is not mutable"))
	case "pocket.tokenomics.ModToModTransfer.SenderModule":
		panic(fmt.Errorf("field SenderModule of message pocket.tokenomics.ModToModTransfer is not mutable"))
	case "pocket.tokenomics.ModToModTransfer.RecipientModule":
		panic(fmt.Errorf("field RecipientModule of message pocket.tokenomics.ModToModTransfer is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.tokenomics.ModToModTransfer"))
		}
...
func (x *fastReflection_ModToModTransfer) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.tokenomics.ModToModTransfer", d.FullName()))
	}
	panic("unreachable")
}
...
func (SettlementOpReason) Descriptor() protoreflect.EnumDescriptor {
	return file_pocket_tokenomics_types_proto_enumTypes[0].Descriptor()
}

func (SettlementOpReason) Type() protoreflect.EnumType {
	return &file_pocket_tokenomics_types_proto_enumTypes[0]
}
...
func (SettlementOpReason) EnumDescriptor() ([]byte, []int) {
	return file_pocket_tokenomics_types_proto_rawDescGZIP(), []int{0}
}
...
type MintBurnOp struct {
	...
	OpReason          SettlementOpReason `protobuf:"varint,1,opt,name=op_reason,json=opReason,proto3,enum=pocket.tokenomics.SettlementOpReason" json:"op_reason,omitempty"`
...
func (*MintBurnOp) Descriptor() ([]byte, []int) {
	return file_pocket_tokenomics_types_proto_rawDescGZIP(), []int{1}
}
...
func (*ModToAcctTransfer) Descriptor() ([]byte, []int) {
	return file_pocket_tokenomics_types_proto_rawDescGZIP(), []int{2}
}
...
func (*ModToModTransfer) Descriptor() ([]byte, []int) {
	return file_pocket_tokenomics_types_proto_rawDescGZIP(), []int{3}
}
...
var file_pocket_tokenomics_types_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x6f, 0x6d,
	0x69, 0x63, 0x73, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	,
	...
	0x73, 0x66, 0x65, 0x72, 0x73, 0x22, 0xe2, 0x01, 0x0a, 0x0a, 0x4d, 0x69, 0x6e, 0x74, 0x42, 0x75,
	0x72, 0x6e, 0x4f, 0x70, 0x12, 0x51, 0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74,
	...
	,
}

var (
	file_pocket_tokenomics_types_proto_rawDescOnce sync.Once
	file_pocket_tokenomics_types_proto_rawDescData = file_pocket_tokenomics_types_proto_rawDesc
)

func file_pocket_tokenomics_types_proto_rawDescGZIP() []byte {
	file_pocket_tokenomics_types_proto_rawDescOnce.Do(func() {
		file_pocket_tokenomics_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_pocket_tokenomics_types_proto_rawDescData)
	})
	return file_pocket_tokenomics_types_proto_rawDescData
}

var file_pocket_tokenomics_types_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pocket_tokenomics_types_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pocket_tokenomics_types_proto_goTypes = []interface{}{
	(SettlementOpReason)(0),       // 0: pocket.tokenomics.SettlementOpReason
	(*ClaimSettlementResult)(nil), // 1: pocket.tokenomics.ClaimSettlementResult
	(*MintBurnOp)(nil),            // 2: pocket.tokenomics.MintBurnOp
	(*ModToAcctTransfer)(nil),     // 3: pocket.tokenomics.ModToAcctTransfer
	(*ModToModTransfer)(nil),      // 4: pocket.tokenomics.ModToModTransfer
	(*proof.Claim)(nil),           // 5: pocket.proof.Claim
	(*v1beta1.Coin)(nil),          // 6: cosmos.base.v1beta1.Coin
}
var file_pocket_tokenomics_types_proto_depIdxs = []int32{
	5,  // 0: pocket.tokenomics.ClaimSettlementResult.claim:type_name -> pocket.proof.Claim
	2,  // 1: pocket.tokenomics.ClaimSettlementResult.mints:type_name -> pocket.tokenomics.MintBurnOp
	2,  // 2: pocket.tokenomics.ClaimSettlementResult.burns:type_name -> pocket.tokenomics.MintBurnOp
	4,  // 3: pocket.tokenomics.ClaimSettlementResult.mod_to_mod_transfers:type_name -> pocket.tokenomics.ModToModTransfer
	3,  // 4: pocket.tokenomics.ClaimSettlementResult.mod_to_acct_transfers:type_name -> pocket.tokenomics.ModToAcctTransfer
	0,  // 5: pocket.tokenomics.MintBurnOp.op_reason:type_name -> pocket.tokenomics.SettlementOpReason
	6,  // 6: pocket.tokenomics.MintBurnOp.coin:type_name -> cosmos.base.v1beta1.Coin
	0,  // 7: pocket.tokenomics.ModToAcctTransfer.op_reason:type_name -> pocket.tokenomics.SettlementOpReason
	6,  // 8: pocket.tokenomics.ModToAcctTransfer.coin:type_name -> cosmos.base.v1beta1.Coin
	0,  // 9: pocket.tokenomics.ModToModTransfer.op_reason:type_name -> pocket.tokenomics.SettlementOpReason
	6,  // 10: pocket.tokenomics.ModToModTransfer.coin:type_name -> cosmos.base.v1beta1.Coin
...
func init() { file_pocket_tokenomics_types_proto_init() }
func file_pocket_tokenomics_types_proto_init() {
	if File_pocket_tokenomics_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pocket_tokenomics_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_tokenomics_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_tokenomics_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_tokenomics_types_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pocket_tokenomics_types_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pocket_tokenomics_types_proto_goTypes,
		DependencyIndexes: file_pocket_tokenomics_types_proto_depIdxs,
		EnumInfos:         file_pocket_tokenomics_types_proto_enumTypes,
		MessageInfos:      file_pocket_tokenomics_types_proto_msgTypes,
	}.Build()
	File_pocket_tokenomics_types_proto = out.File
	file_pocket_tokenomics_types_proto_rawDesc = nil
	file_pocket_tokenomics_types_proto_goTypes = nil
	file_pocket_tokenomics_types_proto_depIdxs = nil
}
