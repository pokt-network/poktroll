...
func init() {
	...
	md_PersistedSMT = File_poktroll_proof_types_proto.Messages().ByName("PersistedSMT")
...
func (x *PersistedSMT) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_proof_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PersistedSMT) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.proof.PersistedSMT.session_header":
		return x.SessionHeader != nil
	case "poktroll.proof.PersistedSMT.supplier_operator_address":
		return x.SupplierOperatorAddress != ""
	case "poktroll.proof.PersistedSMT.smt_root":
		return len(x.SmtRoot) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.PersistedSMT"))
		}
		panic(fmt.Errorf("message poktroll.proof.PersistedSMT does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PersistedSMT) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.proof.PersistedSMT does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PersistedSMT) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.PersistedSMT.session_header":
		...
		return protoreflect.ValueOfMessage(x.SessionHeader.ProtoReflect())
	case "poktroll.proof.PersistedSMT.supplier_operator_address":
		panic(fmt.Errorf("field supplier_operator_address of message poktroll.proof.PersistedSMT is not mutable"))
	case "poktroll.proof.PersistedSMT.smt_root":
		panic(fmt.Errorf("field smt_root of message poktroll.proof.PersistedSMT is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.PersistedSMT"))
		}
...
func (x *fastReflection_PersistedSMT) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.proof.PersistedSMT", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_PersistedSMT) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.SmtRoot) > 0 {
			i -= len(x.SmtRoot)
			copy(dAtA[i:], x.SmtRoot)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SmtRoot)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.SupplierOperatorAddress) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SmtRoot", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SmtRoot = append(x.SmtRoot[:0], dAtA[iNdEx:postIndex]...)
				if x.SmtRoot == nil {
					x.SmtRoot = []byte{}
				}
				iNdEx = postIndex
...
var file_pocket_proof_types_proto_rawDesc = []byte{
	...
	,
	...
	0x07, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x02, 0x42, 0x9e, 0x01, 0xd8, 0xe2, 0x1e,
...
var file_poktroll_proof_types_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_poktroll_proof_types_proto_goTypes = []interface{}{
	...
	(*PersistedSMT)(nil),          // 5: poktroll.proof.PersistedSMT
	(*session.SessionHeader)(nil), // 6: poktroll.session.SessionHeader
}
var file_poktroll_proof_types_proto_depIdxs = []int32{
	6, // 0: poktroll.proof.Proof.session_header:type_name -> poktroll.session.SessionHeader
	6, // 1: poktroll.proof.Claim.session_header:type_name -> poktroll.session.SessionHeader
	2, // 2: poktroll.proof.Claim.proof_validation_status:type_name -> poktroll.proof.ClaimProofStatus
	6, // 3: poktroll.proof.PersistedSMT.session_header:type_name -> poktroll.session.SessionHeader
...
func file_pocket_proof_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_poktroll_proof_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
