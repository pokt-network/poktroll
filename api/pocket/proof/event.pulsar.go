...
func init() {
	file_pocket_proof_event_proto_init()
	md_EventParamsUpdated = File_pocket_proof_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.proof.EventParamsUpdated.params":
		return x.Params != nil
	case "pocket.proof.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.proof.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message pocket.proof.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.proof.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.proof.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message pocket.proof.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.proof.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.proof.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
var file_pocket_proof_event_proto_rawDesc = []byte{
	...
	0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xa9, 0x01,
	0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x64, 0x12, 0x41, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x70, 0x72,
	0x6f, 0x6f, 0x66, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42, 0x13, 0xc8, 0xde, 0x1f, 0x00,
	...
	,
...
var file_pocket_proof_event_proto_goTypes = []interface{}{
	...
	(*EventParamsUpdated)(nil),        // 5: pocket.proof.EventParamsUpdated
...
var file_pocket_proof_event_proto_depIdxs = []int32{
	...
	10, // 12: pocket.proof.EventParamsUpdated.params:type_name -> pocket.proof.Params
