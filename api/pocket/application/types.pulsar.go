...
func init() {
	...
	md_Application = File_pocket_application_types_proto.Messages().ByName("Application")
...
func (x *Application) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_application_types_proto_msgTypes[0]
...
func (x *fastReflection_Application) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "pocket.application.Application.address":
		return x.Address != ""
	case "pocket.application.Application.stake":
		return x.Stake != nil
	case "pocket.application.Application.service_configs":
		return len(x.ServiceConfigs) != 0
	case "pocket.application.Application.delegatee_gateway_addresses":
		return len(x.DelegateeGatewayAddresses) != 0
	case "pocket.application.Application.pending_undelegations":
	...
	default:
		...
		panic(fmt.Errorf("message pocket.application.Application does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Application) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.application.Application does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Application) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "pocket.application.Application.unstake_session_end_height":
		panic(fmt.Errorf("field unstake_session_end_height of message pocket.application.Application is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.application.Application"))
		}
...
func (x *fastReflection_Application) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.application.Application", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_application_types_proto_init()
	md_UndelegatingGatewayList = File_pocket_application_types_proto.Messages().ByName("UndelegatingGatewayList")
...
func (x *UndelegatingGatewayList) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_application_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_UndelegatingGatewayList) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.application.UndelegatingGatewayList.gateway_addresses":
		return len(x.GatewayAddresses) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.application.UndelegatingGatewayList"))
		}
		panic(fmt.Errorf("message pocket.application.UndelegatingGatewayList does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_UndelegatingGatewayList) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.application.UndelegatingGatewayList does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_UndelegatingGatewayList) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.application.UndelegatingGatewayList", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_pocket_application_types_proto_init()
	md_PendingApplicationTransfer = File_pocket_application_types_proto.Messages().ByName("PendingApplicationTransfer")
...
func (x *PendingApplicationTransfer) slowProtoReflect() protoreflect.Message {
	mi := &file_pocket_application_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PendingApplicationTransfer) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pocket.application.PendingApplicationTransfer.destination_address":
		return x.DestinationAddress != ""
	case "pocket.application.PendingApplicationTransfer.session_end_height":
		return x.SessionEndHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.application.PendingApplicationTransfer"))
		}
		panic(fmt.Errorf("message pocket.application.PendingApplicationTransfer does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PendingApplicationTransfer) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pocket.application.PendingApplicationTransfer does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PendingApplicationTransfer) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pocket.application.PendingApplicationTransfer.destination_address":
		panic(fmt.Errorf("field destination_address of message pocket.application.PendingApplicationTransfer is not mutable"))
	case "pocket.application.PendingApplicationTransfer.session_end_height":
		panic(fmt.Errorf("field session_end_height of message pocket.application.PendingApplicationTransfer is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pocket.application.PendingApplicationTransfer"))
		}
...
func (x *fastReflection_PendingApplicationTransfer) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pocket.application.PendingApplicationTransfer", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Application) Descriptor() ([]byte, []int) {
	return file_pocket_application_types_proto_rawDescGZIP(), []int{0}
}
...
func (*UndelegatingGatewayList) Descriptor() ([]byte, []int) {
	return file_pocket_application_types_proto_rawDescGZIP(), []int{1}
}
...
func (*PendingApplicationTransfer) Descriptor() ([]byte, []int) {
	return file_pocket_application_types_proto_rawDescGZIP(), []int{2}
}
...
var file_pocket_application_types_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2f, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62,
	0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e,
	0x52, 0x05, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x12, 0x50, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	,
	...
	0x6e, 0x45, 0x6e, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x59, 0x0a, 0x10, 0x70, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x70, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x61, 0x70,
	...
	0x45, 0x6e, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0xb6, 0x01, 0xd8, 0xe2, 0x1e, 0x01,
	...
	0x58, 0xaa, 0x02, 0x12, 0x50, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xca, 0x02, 0x12, 0x50, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x5c,
	0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xe2, 0x02, 0x1e, 0x50, 0x6f,
	0x63, 0x6b, 0x65, 0x74, 0x5c, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x13, 0x50,
	0x6f, 0x63, 0x6b, 0x65, 0x74, 0x3a, 0x3a, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pocket_application_types_proto_rawDescOnce sync.Once
	file_pocket_application_types_proto_rawDescData = file_pocket_application_types_proto_rawDesc
)

func file_pocket_application_types_proto_rawDescGZIP() []byte {
	file_pocket_application_types_proto_rawDescOnce.Do(func() {
		file_pocket_application_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_pocket_application_types_proto_rawDescData)
	})
	return file_pocket_application_types_proto_rawDescData
}

var file_pocket_application_types_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pocket_application_types_proto_goTypes = []interface{}{
	...
	nil,                                     // 3: pocket.application.Application.PendingUndelegationsEntry
	(*v1beta1.Coin)(nil),                    // 4: cosmos.base.v1beta1.Coin
	(*shared.ApplicationServiceConfig)(nil), // 5: pocket.shared.ApplicationServiceConfig
}
var file_pocket_application_types_proto_depIdxs = []int32{
	4, // 0: pocket.application.Application.stake:type_name -> cosmos.base.v1beta1.Coin
	5, // 1: pocket.application.Application.service_configs:type_name -> pocket.shared.ApplicationServiceConfig
	3, // 2: pocket.application.Application.pending_undelegations:type_name -> pocket.application.Application.PendingUndelegationsEntry
...
func file_pocket_application_types_proto_init() {
	if File_pocket_application_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pocket_application_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_application_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pocket_application_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_pocket_application_types_proto_goTypes,
		DependencyIndexes: file_pocket_application_types_proto_depIdxs,
		MessageInfos:      file_pocket_application_types_proto_msgTypes,
	}.Build()
	File_pocket_application_types_proto = out.File
	file_pocket_application_types_proto_rawDesc = nil
	file_pocket_application_types_proto_goTypes = nil
	file_pocket_application_types_proto_depIdxs = nil
}
