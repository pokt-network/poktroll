...
var file_poktroll_supplier_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_poktroll_supplier_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),              // 2: poktroll.supplier.Params
}
var file_poktroll_supplier_query_proto_depIdxs = []int32{
	2, // 0: poktroll.supplier.QueryParamsResponse.params:type_name -> poktroll.supplier.Params
	0, // 1: poktroll.supplier.Query.Params:input_type -> poktroll.supplier.QueryParamsRequest
	1, // 2: poktroll.supplier.Query.Params:output_type -> poktroll.supplier.QueryParamsResponse
