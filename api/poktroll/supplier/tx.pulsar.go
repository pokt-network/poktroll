...
var file_poktroll_supplier_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_poktroll_supplier_tx_proto_depIdxs = []int32{
	2, // 0: poktroll.supplier.MsgUpdateParams.params:type_name -> poktroll.supplier.Params
	0, // 1: poktroll.supplier.Msg.UpdateParams:input_type -> poktroll.supplier.MsgUpdateParams
	1, // 2: poktroll.supplier.Msg.UpdateParams:output_type -> poktroll.supplier.MsgUpdateParamsResponse
