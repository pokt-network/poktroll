...
func (x *fastReflection_MsgClaimMorseSupplier) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Services != nil {
		value := protoreflect.ValueOfMessage(x.Services.ProtoReflect())
...
func (x *fastReflection_MsgClaimMorseSupplier) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.migration.MsgClaimMorseSupplier.morse_signature":
		x.MorseSignature = value.Bytes()
	case "poktroll.migration.MsgClaimMorseSupplier.services":
		x.Services = value.Message().Interface().(*shared.SupplierServiceConfig)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.MsgClaimMorseSupplier"))
		}
...
func (x *fastReflection_MsgClaimMorseSupplier) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.migration.MsgClaimMorseSupplier.services":
		if x.Services == nil {
			x.Services = new(shared.SupplierServiceConfig)
		}
		return protoreflect.ValueOfMessage(x.Services.ProtoReflect())
	case "poktroll.migration.MsgClaimMorseSupplier.shannon_dest_address":
...
func (x *fastReflection_MsgClaimMorseSupplier) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.Services != nil {
			encoded, err := options.Marshal(x.Services)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				...
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Services); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type MsgClaimMorseSupplier struct {
	...
	Services *shared.SupplierServiceConfig `protobuf:"bytes,5,opt,name=services,proto3" json:"services,omitempty"`
}
...
var file_poktroll_migration_tx_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x6f, 0x6b, 0x74,
	...
	0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe9, 0x02, 0x0a, 0x15, 0x4d,
	0x73, 0x67, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x53, 0x75, 0x70, 0x70,
	0x6c, 0x69, 0x65, 0x72, 0x12, 0x62, 0x0a, 0x14, 0x73, 0x68, 0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f,
	...
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x50, 0x0a, 0x08, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x70, 0x6f,
	...
	0x73, 0x52, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x3a, 0x19, 0x82, 0xe7, 0xb0,
	0x2a, 0x14, 0x73, 0x68, 0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xbb, 0x03, 0x0a, 0x1d, 0x4d, 0x73, 0x67, 0x43, 0x6c,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x42, 0x16, 0xea, 0xde, 0x1f, 0x12, 0x73, 0x65, 0x73, 0x73, 0x69,
	...
	0x43, 0x0a, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28,
	...
	0x6c, 0x69, 0x65, 0x72, 0x32, 0xe3, 0x04, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x60, 0x0a, 0x0c,
...
var file_poktroll_migration_tx_proto_depIdxs = []int32{
	...
	13, // 3: poktroll.migration.MsgClaimMorseApplication.service_config:type_name -> poktroll.shared.ApplicationServiceConfig
