...
func (x *fastReflection_MsgUploadMorseState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.State) != 0 {
		value := protoreflect.ValueOfBytes(x.State)
...
func (x *fastReflection_MsgUploadMorseState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.migration.MsgUploadMorseState.state":
		panic(fmt.Errorf("field state of message poktroll.migration.MsgUploadMorseState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.MsgUploadMorseState"))
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.State = append(x.State[:0], dAtA[iNdEx:postIndex]...)
				if x.State == nil {
					x.State = []byte{}
				}
				iNdEx = postIndex
...
func (x *MsgUploadMorseState) GetState() []byte {
	if x != nil {
		return x.State
	}
	return nil
...
var file_poktroll_migration_tx_proto_rawDesc = []byte{
	...
	0x0a, 0x13, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x6f, 0x72, 0x73, 0x65,
	...
	0x69, 0x74, 0x79, 0x22, 0x1d, 0x0a, 0x1b, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x4d, 0x6f, 0x72, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x32, 0xdc, 0x01, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x60, 0x0a, 0x0c, 0x55, 0x70,
	...
	0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6c, 0x0a, 0x10,
	0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x27, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x6d, 0x69, 0x67, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4d,
	0x6f, 0x72, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x2f, 0x2e, 0x70, 0x6f, 0x6b, 0x74,
	0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4d,
	0x73, 0x67, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x53, 0x74, 0x61,
...
var file_poktroll_migration_tx_proto_depIdxs = []int32{
	...
	2, // 2: poktroll.migration.Msg.UploadMorseState:input_type -> poktroll.migration.MsgUploadMorseState
	1, // 3: poktroll.migration.Msg.UpdateParams:output_type -> poktroll.migration.MsgUpdateParamsResponse
	3, // 4: poktroll.migration.Msg.UploadMorseState:output_type -> poktroll.migration.MsgUploadMorseStateResponse
