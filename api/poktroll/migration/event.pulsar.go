...
var (
	...
	fd_EventMorseAccountClaimed_claimed_at_height    protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventMorseAccountClaimed_claimed_at_height = md_EventMorseAccountClaimed.Fields().ByName("claimed_at_height")
...
func (x *fastReflection_EventMorseAccountClaimed) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ClaimedAtHeight != int64(0) {
		...
		if !f(fd_EventMorseAccountClaimed_claimed_at_height, value) {
			return
		}
	}
...
func (x *fastReflection_EventMorseAccountClaimed) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseAccountClaimed.claimed_at_height":
...
func (x *fastReflection_EventMorseAccountClaimed) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.migration.EventMorseAccountClaimed.claimed_at_height":
		panic(fmt.Errorf("field claimed_at_height of message poktroll.migration.EventMorseAccountClaimed is not mutable"))
	case "poktroll.migration.EventMorseAccountClaimed.shannon_dest_address":
...
var (
	...
	fd_EventMorseApplicationClaimed_claimed_at_height         protoreflect.FieldDescriptor
	fd_EventMorseApplicationClaimed_claimed_balance           protoreflect.FieldDescriptor
	fd_EventMorseApplicationClaimed_shannon_dest_address      protoreflect.FieldDescriptor
	...
	fd_EventMorseApplicationClaimed_service_id                protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventMorseApplicationClaimed_claimed_at_height = md_EventMorseApplicationClaimed.Fields().ByName("claimed_at_height")
	fd_EventMorseApplicationClaimed_claimed_balance = md_EventMorseApplicationClaimed.Fields().ByName("claimed_balance")
	fd_EventMorseApplicationClaimed_shannon_dest_address = md_EventMorseApplicationClaimed.Fields().ByName("shannon_dest_address")
	...
	fd_EventMorseApplicationClaimed_service_id = md_EventMorseApplicationClaimed.Fields().ByName("service_id")
...
func (x *fastReflection_EventMorseApplicationClaimed) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ClaimedAtHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.ClaimedAtHeight)
		if !f(fd_EventMorseApplicationClaimed_claimed_at_height, value) {
			return
		}
	}
	if x.ClaimedBalance != nil {
	...
	if x.ShannonDestAddress != "" {
		value := protoreflect.ValueOfString(x.ShannonDestAddress)
		if !f(fd_EventMorseApplicationClaimed_shannon_dest_address, value) {
			return
		}
	}
	if x.MorseSrcAddress != "" {
	...
	if x.ServiceId != "" {
		...
		if !f(fd_EventMorseApplicationClaimed_service_id, value) {
			return
		}
	}
...
func (x *fastReflection_EventMorseApplicationClaimed) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseApplicationClaimed.claimed_at_height":
		return x.ClaimedAtHeight != int64(0)
	case "poktroll.migration.EventMorseApplicationClaimed.claimed_balance":
		return x.ClaimedBalance != nil
	case "poktroll.migration.EventMorseApplicationClaimed.shannon_dest_address":
		return x.ShannonDestAddress != ""
	...
	case "poktroll.migration.EventMorseApplicationClaimed.service_id":
		return x.ServiceId != ""
...
func (x *fastReflection_EventMorseApplicationClaimed) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.migration.EventMorseApplicationClaimed.claimed_at_height":
		panic(fmt.Errorf("field claimed_at_height of message poktroll.migration.EventMorseApplicationClaimed is not mutable"))
	case "poktroll.migration.EventMorseApplicationClaimed.shannon_dest_address":
		panic(fmt.Errorf("field shannon_dest_address of message poktroll.migration.EventMorseApplicationClaimed is not mutable"))
	case "poktroll.migration.EventMorseApplicationClaimed.morse_src_address":
		panic(fmt.Errorf("field morse_src_address of message poktroll.migration.EventMorseApplicationClaimed is not mutable"))
	case "poktroll.migration.EventMorseApplicationClaimed.service_id":
		panic(fmt.Errorf("field service_id of message poktroll.migration.EventMorseApplicationClaimed is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.EventMorseApplicationClaimed"))
		}
...
var (
	...
	fd_EventMorseSupplierClaimed_claimed_at_height    protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_claimed_balance      protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_shannon_dest_address protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_morse_src_address    protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_claimedSupplierStake protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_service_id           protoreflect.FieldDescriptor
	fd_EventMorseSupplierClaimed_supplier             protoreflect.FieldDescriptor
)

func init() {
	file_poktroll_migration_event_proto_init()
	md_EventMorseSupplierClaimed = File_poktroll_migration_event_proto.Messages().ByName("EventMorseSupplierClaimed")
	fd_EventMorseSupplierClaimed_claimed_at_height = md_EventMorseSupplierClaimed.Fields().ByName("claimed_at_height")
	fd_EventMorseSupplierClaimed_claimed_balance = md_EventMorseSupplierClaimed.Fields().ByName("claimed_balance")
	fd_EventMorseSupplierClaimed_shannon_dest_address = md_EventMorseSupplierClaimed.Fields().ByName("shannon_dest_address")
	fd_EventMorseSupplierClaimed_morse_src_address = md_EventMorseSupplierClaimed.Fields().ByName("morse_src_address")
	fd_EventMorseSupplierClaimed_claimedSupplierStake = md_EventMorseSupplierClaimed.Fields().ByName("claimedSupplierStake")
	fd_EventMorseSupplierClaimed_service_id = md_EventMorseSupplierClaimed.Fields().ByName("service_id")
...
func (x *EventMorseSupplierClaimed) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_migration_event_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_EventMorseSupplierClaimed) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ClaimedAtHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.ClaimedAtHeight)
		if !f(fd_EventMorseSupplierClaimed_claimed_at_height, value) {
			return
		}
	}
	if x.ClaimedBalance != nil {
	...
	if x.ShannonDestAddress != "" {
		value := protoreflect.ValueOfString(x.ShannonDestAddress)
		if !f(fd_EventMorseSupplierClaimed_shannon_dest_address, value) {
			return
		}
	}
	if x.MorseSrcAddress != "" {
	...
	if x.ClaimedSupplierStake != nil {
		...
		if !f(fd_EventMorseSupplierClaimed_claimedSupplierStake, value) {
			return
		}
	}
	if x.ServiceId != "" {
		value := protoreflect.ValueOfString(x.ServiceId)
		if !f(fd_EventMorseSupplierClaimed_service_id, value) {
			return
		}
	}
	if x.Supplier != nil {
...
func (x *fastReflection_EventMorseSupplierClaimed) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseSupplierClaimed.claimed_at_height":
		return x.ClaimedAtHeight != int64(0)
	case "poktroll.migration.EventMorseSupplierClaimed.claimed_balance":
		return x.ClaimedBalance != nil
	case "poktroll.migration.EventMorseSupplierClaimed.shannon_dest_address":
		return x.ShannonDestAddress != ""
	case "poktroll.migration.EventMorseSupplierClaimed.morse_src_address":
		return x.MorseSrcAddress != ""
	case "poktroll.migration.EventMorseSupplierClaimed.claimedSupplierStake":
		return x.ClaimedSupplierStake != nil
	case "poktroll.migration.EventMorseSupplierClaimed.service_id":
		return x.ServiceId != ""
	case "poktroll.migration.EventMorseSupplierClaimed.supplier":
		return x.Supplier != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.EventMorseSupplierClaimed"))
		}
		panic(fmt.Errorf("message poktroll.migration.EventMorseSupplierClaimed does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventMorseSupplierClaimed) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.migration.EventMorseSupplierClaimed does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventMorseSupplierClaimed) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.migration.EventMorseSupplierClaimed.claimed_at_height":
		panic(fmt.Errorf("field claimed_at_height of message poktroll.migration.EventMorseSupplierClaimed is not mutable"))
	case "poktroll.migration.EventMorseSupplierClaimed.shannon_dest_address":
		panic(fmt.Errorf("field shannon_dest_address of message poktroll.migration.EventMorseSupplierClaimed is not mutable"))
	case "poktroll.migration.EventMorseSupplierClaimed.morse_src_address":
		panic(fmt.Errorf("field morse_src_address of message poktroll.migration.EventMorseSupplierClaimed is not mutable"))
	case "poktroll.migration.EventMorseSupplierClaimed.service_id":
		panic(fmt.Errorf("field service_id of message poktroll.migration.EventMorseSupplierClaimed is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.EventMorseSupplierClaimed"))
		}
...
func (x *fastReflection_EventMorseSupplierClaimed) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.migration.EventMorseSupplierClaimed", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	md_EventMorseGatewayClaimed                       protoreflect.MessageDescriptor
	fd_EventMorseGatewayClaimed_claimed_at_height     protoreflect.FieldDescriptor
	fd_EventMorseGatewayClaimed_claimed_balance       protoreflect.FieldDescriptor
	fd_EventMorseGatewayClaimed_shannon_dest_address  protoreflect.FieldDescriptor
	fd_EventMorseGatewayClaimed_morse_src_address     protoreflect.FieldDescriptor
	fd_EventMorseGatewayClaimed_claimed_gateway_stake protoreflect.FieldDescriptor
	fd_EventMorseGatewayClaimed_gateway               protoreflect.FieldDescriptor
)

func init() {
	file_poktroll_migration_event_proto_init()
	md_EventMorseGatewayClaimed = File_poktroll_migration_event_proto.Messages().ByName("EventMorseGatewayClaimed")
	fd_EventMorseGatewayClaimed_claimed_at_height = md_EventMorseGatewayClaimed.Fields().ByName("claimed_at_height")
	fd_EventMorseGatewayClaimed_claimed_balance = md_EventMorseGatewayClaimed.Fields().ByName("claimed_balance")
	fd_EventMorseGatewayClaimed_shannon_dest_address = md_EventMorseGatewayClaimed.Fields().ByName("shannon_dest_address")
	fd_EventMorseGatewayClaimed_morse_src_address = md_EventMorseGatewayClaimed.Fields().ByName("morse_src_address")
	fd_EventMorseGatewayClaimed_claimed_gateway_stake = md_EventMorseGatewayClaimed.Fields().ByName("claimed_gateway_stake")
	fd_EventMorseGatewayClaimed_gateway = md_EventMorseGatewayClaimed.Fields().ByName("gateway")
}

var _ protoreflect.Message = (*fastReflection_EventMorseGatewayClaimed)(nil)

type fastReflection_EventMorseGatewayClaimed EventMorseGatewayClaimed

func (x *EventMorseGatewayClaimed) ProtoReflect() protoreflect.Message {
	return (*fastReflection_EventMorseGatewayClaimed)(x)
}

func (x *EventMorseGatewayClaimed) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_migration_event_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_EventMorseGatewayClaimed_messageType fastReflection_EventMorseGatewayClaimed_messageType
var _ protoreflect.MessageType = fastReflection_EventMorseGatewayClaimed_messageType{}

type fastReflection_EventMorseGatewayClaimed_messageType struct{}

func (x fastReflection_EventMorseGatewayClaimed_messageType) Zero() protoreflect.Message {
	return (*fastReflection_EventMorseGatewayClaimed)(nil)
}
func (x fastReflection_EventMorseGatewayClaimed_messageType) New() protoreflect.Message {
	return new(fastReflection_EventMorseGatewayClaimed)
}
func (x fastReflection_EventMorseGatewayClaimed_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_EventMorseGatewayClaimed
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_EventMorseGatewayClaimed) Descriptor() protoreflect.MessageDescriptor {
	return md_EventMorseGatewayClaimed
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_EventMorseGatewayClaimed) Type() protoreflect.MessageType {
	return _fastReflection_EventMorseGatewayClaimed_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_EventMorseGatewayClaimed) New() protoreflect.Message {
	return new(fastReflection_EventMorseGatewayClaimed)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_EventMorseGatewayClaimed) Interface() protoreflect.ProtoMessage {
	return (*EventMorseGatewayClaimed)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_EventMorseGatewayClaimed) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ClaimedAtHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.ClaimedAtHeight)
		if !f(fd_EventMorseGatewayClaimed_claimed_at_height, value) {
			return
		}
	}
	if x.ClaimedBalance != nil {
		value := protoreflect.ValueOfMessage(x.ClaimedBalance.ProtoReflect())
		if !f(fd_EventMorseGatewayClaimed_claimed_balance, value) {
			return
		}
	}
	if x.ShannonDestAddress != "" {
		value := protoreflect.ValueOfString(x.ShannonDestAddress)
		if !f(fd_EventMorseGatewayClaimed_shannon_dest_address, value) {
			return
		}
	}
	if x.MorseSrcAddress != "" {
		value := protoreflect.ValueOfString(x.MorseSrcAddress)
		if !f(fd_EventMorseGatewayClaimed_morse_src_address, value) {
			return
		}
	}
	if x.ClaimedGatewayStake != nil {
		value := protoreflect.ValueOfMessage(x.ClaimedGatewayStake.ProtoReflect())
		if !f(fd_EventMorseGatewayClaimed_claimed_gateway_stake, value) {
			return
		}
	}
	if x.Gateway != nil {
		value := protoreflect.ValueOfMessage(x.Gateway.ProtoReflect())
		if !f(fd_EventMorseGatewayClaimed_gateway, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_EventMorseGatewayClaimed) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		return x.ClaimedAtHeight != int64(0)
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_balance":
		return x.ClaimedBalance != nil
	case "poktroll.migration.EventMorseGatewayClaimed.shannon_dest_address":
		return x.ShannonDestAddress != ""
	case "poktroll.migration.EventMorseGatewayClaimed.morse_src_address":
		return x.MorseSrcAddress != ""
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_gateway_stake":
		return x.ClaimedGatewayStake != nil
	case "poktroll.migration.EventMorseGatewayClaimed.gateway":
		return x.Gateway != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.EventMorseGatewayClaimed"))
		}
		panic(fmt.Errorf("message poktroll.migration.EventMorseGatewayClaimed does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventMorseGatewayClaimed) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		x.ClaimedAtHeight = int64(0)
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_balance":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_EventMorseGatewayClaimed) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		value := x.ClaimedAtHeight
		return protoreflect.ValueOfInt64(value)
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.migration.EventMorseGatewayClaimed does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventMorseGatewayClaimed) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		x.ClaimedAtHeight = value.Int()
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_balance":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventMorseGatewayClaimed) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_balance":
		if x.ClaimedBalance == nil {
			x.ClaimedBalance = new(v1beta1.Coin)
	...
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		panic(fmt.Errorf("field claimed_at_height of message poktroll.migration.EventMorseGatewayClaimed is not mutable"))
	case "poktroll.migration.EventMorseGatewayClaimed.shannon_dest_address":
		panic(fmt.Errorf("field shannon_dest_address of message poktroll.migration.EventMorseGatewayClaimed is not mutable"))
	case "poktroll.migration.EventMorseGatewayClaimed.morse_src_address":
		panic(fmt.Errorf("field morse_src_address of message poktroll.migration.EventMorseGatewayClaimed is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.migration.EventMorseGatewayClaimed"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_EventMorseGatewayClaimed) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_at_height":
		return protoreflect.ValueOfInt64(int64(0))
	case "poktroll.migration.EventMorseGatewayClaimed.claimed_balance":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_EventMorseGatewayClaimed) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.migration.EventMorseGatewayClaimed", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_EventMorseGatewayClaimed) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EventMorseGatewayClaimed) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_EventMorseGatewayClaimed) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_EventMorseGatewayClaimed) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*EventMorseGatewayClaimed)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EventMorseGatewayClaimed: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EventMorseGatewayClaimed: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
type EventMorseAccountClaimed struct {
	...
	ClaimedAtHeight int64 `protobuf:"varint,1,opt,name=claimed_at_height,json=claimedAtHeight,proto3" json:"claimed_at_height,omitempty"`
...
func (x *EventMorseAccountClaimed) GetClaimedAtHeight() int64 {
	if x != nil {
...
type EventMorseApplicationClaimed struct {
	...
	ClaimedApplicationStake *v1beta1.Coin `protobuf:"bytes,5,opt,name=claimed_application_stake,json=claimedApplicationStake,proto3" json:"claimed_application_stake,omitempty"`
	...
	Application *application.Application `protobuf:"bytes,7,opt,name=application,proto3" json:"application,omitempty"`
}
...
func (x *EventMorseApplicationClaimed) GetClaimedAtHeight() int64 {
	if x != nil {
		return x.ClaimedAtHeight
	}
	return 0
...
func (x *EventMorseApplicationClaimed) GetShannonDestAddress() string {
	if x != nil {
		return x.ShannonDestAddress
	}
	return ""
...
func (x *EventMorseApplicationClaimed) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
type EventMorseSupplierClaimed struct {
	...
	ClaimedSupplierStake *v1beta1.Coin `protobuf:"bytes,5,opt,name=claimedSupplierStake,proto3" json:"claimedSupplierStake,omitempty"`
	// The service ID of the service which the Supplier is staked for.
	ServiceId string `protobuf:"bytes,6,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	// The Supplier which was staked as a result of the claim.
	Supplier *shared.Supplier `protobuf:"bytes,7,opt,name=supplier,proto3" json:"supplier,omitempty"`
}
...
func (*EventMorseSupplierClaimed) Descriptor() ([]byte, []int) {
	return file_poktroll_migration_event_proto_rawDescGZIP(), []int{3}
}

func (x *EventMorseSupplierClaimed) GetClaimedAtHeight() int64 {
	if x != nil {
		return x.ClaimedAtHeight
	}
	return 0
...
func (x *EventMorseSupplierClaimed) GetShannonDestAddress() string {
	if x != nil {
		return x.ShannonDestAddress
	}
	return ""
...
func (x *EventMorseSupplierClaimed) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
// EventMorseGatewayClaimed is emitted when a MorseAccount is claimed on-chain as a staked Gateway.
type EventMorseGatewayClaimed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ClaimedGatewayStake *v1beta1.Coin `protobuf:"bytes,5,opt,name=claimed_gateway_stake,json=claimedGatewayStake,proto3" json:"claimed_gateway_stake,omitempty"`
...
func (x *EventMorseGatewayClaimed) Reset() {
	*x = EventMorseGatewayClaimed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_poktroll_migration_event_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *EventMorseGatewayClaimed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EventMorseGatewayClaimed) ProtoMessage() {}

// Deprecated: Use EventMorseGatewayClaimed.ProtoReflect.Descriptor instead.
func (*EventMorseGatewayClaimed) Descriptor() ([]byte, []int) {
	return file_poktroll_migration_event_proto_rawDescGZIP(), []int{4}
}

func (x *EventMorseGatewayClaimed) GetClaimedAtHeight() int64 {
	if x != nil {
		return x.ClaimedAtHeight
	}
	return 0
...
func (x *EventMorseGatewayClaimed) GetClaimedBalance() *v1beta1.Coin {
	if x != nil {
		return x.ClaimedBalance
	}
	return nil
...
func (x *EventMorseGatewayClaimed) GetShannonDestAddress() string {
	if x != nil {
		return x.ShannonDestAddress
	}
	return ""
...
func (x *EventMorseGatewayClaimed) GetMorseSrcAddress() string {
	if x != nil {
		return x.MorseSrcAddress
	}
	return ""
...
func (x *EventMorseGatewayClaimed) GetClaimedGatewayStake() *v1beta1.Coin {
	if x != nil {
...
func (x *EventMorseGatewayClaimed) GetGateway() *gateway.Gateway {
	if x != nil {
		return x.Gateway
	}
	return nil
...
var file_poktroll_migration_event_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x26, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f, 0x6d, 0x69, 0x67,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x6d, 0x6f, 0x72, 0x73, 0x65, 0x5f, 0x6f, 0x6e, 0x63,
	0x68, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x20, 0x70, 0x6f, 0x6b, 0x74,
	...
	0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf2, 0x01, 0x0a,
	...
	0x73, 0x22, 0xe1, 0x02, 0x0a, 0x18, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x6f, 0x72, 0x73, 0x65,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x12, 0x41,
	0x0a, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69,
	0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x15, 0xea, 0xde, 0x1f, 0x11, 0x63,
	...
	0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x62,
	0x0a, 0x14, 0x73, 0x68, 0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0xea, 0xde,
	0x1f, 0x14, 0x73, 0x68, 0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61,
	...
	0x73, 0x73, 0x12, 0x41, 0x0a, 0x11, 0x6d, 0x6f, 0x72, 0x73, 0x65, 0x5f, 0x73, 0x72, 0x63, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x15, 0xea,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xe4, 0x04, 0x0a, 0x1c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d,
	0x6f, 0x72, 0x73, 0x65, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x12, 0x41, 0x0a, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65,
	0x64, 0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x42, 0x15, 0xea, 0xde, 0x1f, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x5f, 0x61,
	0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x0f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65,
	0x64, 0x41, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x5b, 0x0a, 0x0f, 0x63, 0x6c, 0x61,
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x62, 0x0a, 0x14, 0x73, 0x68, 0x61, 0x6e, 0x6e, 0x6f,
	0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03,
	...
	,
	...
	0x0b, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xab, 0x04, 0x0a,
	0x19, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x53, 0x75, 0x70, 0x70, 0x6c,
	0x69, 0x65, 0x72, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x12, 0x41, 0x0a, 0x11, 0x63, 0x6c,
	0x61, 0x69, 0x6d, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x15, 0xea, 0xde, 0x1f, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d,
	0x65, 0x64, 0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x0f, 0x63, 0x6c,
	0x61, 0x69, 0x6d, 0x65, 0x64, 0x41, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x5b, 0x0a,
	...
	0x6d, 0x65, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x62, 0x0a, 0x14, 0x73, 0x68,
	0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0xea, 0xde, 0x1f, 0x14, 0x73, 0x68,
	0x61, 0x6e, 0x6e, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	...
	0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x15, 0xea, 0xde, 0x1f, 0x11, 0x6d,
	...
	0x73, 0x12, 0x53, 0x0a, 0x14, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x53, 0x75, 0x70, 0x70,
	0x6c, 0x69, 0x65, 0x72, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x72, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x12, 0x2d, 0x0a, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0e, 0xea, 0xde, 0x1f, 0x0a,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x52, 0x09, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x43, 0x0a, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65,
	0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f,
	...
	0x52, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x22, 0x91, 0x04, 0x0a, 0x18, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x4d, 0x6f, 0x72, 0x73, 0x65, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x43, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x12, 0x41, 0x0a, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d,
	0x65, 0x64, 0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x42, 0x15, 0xea, 0xde, 0x1f, 0x11, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x5f,
	0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x0f, 0x63, 0x6c, 0x61, 0x69, 0x6d,
	0x65, 0x64, 0x41, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x5b, 0x0a, 0x0f, 0x63, 0x6c,
	...
	,
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x07, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x42, 0xb6,
	0x01, 0xd8, 0xe2, 0x1e, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72,
	0x6f, 0x6c, 0x6c, 0x2e, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0a, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x23, 0x63, 0x6f, 0x73,
...
var file_poktroll_migration_event_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_poktroll_migration_event_proto_goTypes = []interface{}{
	...
	(*EventMorseSupplierClaimed)(nil),         // 3: poktroll.migration.EventMorseSupplierClaimed
	(*EventMorseGatewayClaimed)(nil),          // 4: poktroll.migration.EventMorseGatewayClaimed
	(*v1beta1.Coin)(nil),                      // 5: cosmos.base.v1beta1.Coin
	(*application.Application)(nil),           // 6: poktroll.application.Application
	(*shared.Supplier)(nil),                   // 7: poktroll.shared.Supplier
	(*gateway.Gateway)(nil),                   // 8: poktroll.gateway.Gateway
}
var file_poktroll_migration_event_proto_depIdxs = []int32{
	5,  // 0: poktroll.migration.EventMorseAccountClaimed.claimed_balance:type_name -> cosmos.base.v1beta1.Coin
	5,  // 1: poktroll.migration.EventMorseApplicationClaimed.claimed_balance:type_name -> cosmos.base.v1beta1.Coin
	5,  // 2: poktroll.migration.EventMorseApplicationClaimed.claimed_application_stake:type_name -> cosmos.base.v1beta1.Coin
	6,  // 3: poktroll.migration.EventMorseApplicationClaimed.application:type_name -> poktroll.application.Application
	5,  // 4: poktroll.migration.EventMorseSupplierClaimed.claimed_balance:type_name -> cosmos.base.v1beta1.Coin
	5,  // 5: poktroll.migration.EventMorseSupplierClaimed.claimedSupplierStake:type_name -> cosmos.base.v1beta1.Coin
	7,  // 6: poktroll.migration.EventMorseSupplierClaimed.supplier:type_name -> poktroll.shared.Supplier
	5,  // 7: poktroll.migration.EventMorseGatewayClaimed.claimed_balance:type_name -> cosmos.base.v1beta1.Coin
	5,  // 8: poktroll.migration.EventMorseGatewayClaimed.claimed_gateway_stake:type_name -> cosmos.base.v1beta1.Coin
	8,  // 9: poktroll.migration.EventMorseGatewayClaimed.gateway:type_name -> poktroll.gateway.Gateway
...
func file_poktroll_migration_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_poktroll_migration_event_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_poktroll_migration_event_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventMorseGatewayClaimed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
