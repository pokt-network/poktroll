...
func init() {
	file_poktroll_session_event_proto_init()
	md_EventParamsUpdated = File_poktroll_session_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *EventParamsUpdated) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_session_event_proto_msgTypes[0]
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.session.EventParamsUpdated.params":
		return x.Params != nil
	case "poktroll.session.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.session.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message poktroll.session.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.session.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.session.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message poktroll.session.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.session.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.session.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EventParamsUpdated) Descriptor() ([]byte, []int) {
	return file_poktroll_session_event_proto_rawDescGZIP(), []int{0}
}
...
var File_poktroll_session_event_proto protoreflect.FileDescriptor

var file_poktroll_session_event_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x65,
	...
	0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0xaa, 0x01, 0xd8, 0xe2, 0x1e, 0x01, 0x0a,
	0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x73, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0xa2, 0x02, 0x03, 0x50, 0x53, 0x58, 0xaa, 0x02, 0x10, 0x50,
	0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0xca,
	0x02, 0x10, 0x50, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x5c, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0xe2, 0x02, 0x1c, 0x50, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x5c, 0x53, 0x65,
...
var (
	file_poktroll_session_event_proto_rawDescOnce sync.Once
	file_poktroll_session_event_proto_rawDescData = file_poktroll_session_event_proto_rawDesc
)

func file_poktroll_session_event_proto_rawDescGZIP() []byte {
	file_poktroll_session_event_proto_rawDescOnce.Do(func() {
		file_poktroll_session_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_poktroll_session_event_proto_rawDescData)
	})
	return file_poktroll_session_event_proto_rawDescData
}

var file_poktroll_session_event_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_poktroll_session_event_proto_goTypes = []interface{}{
	(*EventParamsUpdated)(nil), // 0: poktroll.session.EventParamsUpdated
	(*Params)(nil),             // 1: poktroll.session.Params
}
var file_poktroll_session_event_proto_depIdxs = []int32{
	1, // 0: poktroll.session.EventParamsUpdated.params:type_name -> poktroll.session.Params
...
func init() { file_poktroll_session_event_proto_init() }
func file_poktroll_session_event_proto_init() {
	if File_poktroll_session_event_proto != nil {
		return
	}
	file_poktroll_session_params_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_poktroll_session_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_poktroll_session_event_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_poktroll_session_event_proto_goTypes,
		DependencyIndexes: file_poktroll_session_event_proto_depIdxs,
		MessageInfos:      file_poktroll_session_event_proto_msgTypes,
	}.Build()
	File_poktroll_session_event_proto = out.File
	file_poktroll_session_event_proto_rawDesc = nil
	file_poktroll_session_event_proto_goTypes = nil
	file_poktroll_session_event_proto_depIdxs = nil
}
