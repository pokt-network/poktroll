...
func (x *fastReflection_Proof) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.proof.Proof.index":
		return x.Index != ""
	case "poktroll.proof.Proof.supplierAddress":
		return x.SupplierAddress != ""
	case "poktroll.proof.Proof.sessionHeader":
		return x.SessionHeader != ""
	case "poktroll.proof.Proof.closestMerkleProof":
...
func (x *fastReflection_Proof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.proof.Proof.index":
		panic(fmt.Errorf("field index of message poktroll.proof.Proof is not mutable"))
	case "poktroll.proof.Proof.supplierAddress":
		panic(fmt.Errorf("field supplierAddress of message poktroll.proof.Proof is not mutable"))
	case "poktroll.proof.Proof.sessionHeader":
		panic(fmt.Errorf("field sessionHeader of message poktroll.proof.Proof is not mutable"))
	case "poktroll.proof.Proof.closestMerkleProof":
		panic(fmt.Errorf("field closestMerkleProof of message poktroll.proof.Proof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Proof"))
		}
...
var file_poktroll_proof_proof_proto_rawDesc = []byte{
	...
	0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x9d, 0x01, 0x0a,
	0x05, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x12,
	0x63, 0x6c, 0x6f, 0x73, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x72, 0x6b, 0x6c, 0x65, 0x50, 0x72, 0x6f,
	0x6f, 0x66, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x73,
	0x74, 0x4d, 0x65, 0x72, 0x6b, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x42, 0x9a, 0x01, 0x0a,
	0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x70, 0x72,
	0x6f, 0x6f, 0x66, 0x42, 0x0a, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
