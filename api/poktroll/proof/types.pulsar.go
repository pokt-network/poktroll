...
var (
	...
	fd_Proof_proof_relay               protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Proof_proof_relay = md_Proof.Fields().ByName("proof_relay")
}
...
func (x *fastReflection_Proof) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ProofRelay) != 0 {
		...
		if !f(fd_Proof_proof_relay, value) {
			return
		}
	}
}
...
func (x *fastReflection_Proof) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.proof.Proof.proof_relay":
...
func (x *fastReflection_Proof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.Proof.proof_relay":
		panic(fmt.Errorf("field proof_relay of message poktroll.proof.Proof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Proof"))
		}
...
func (x *fastReflection_Claim) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.proof.Claim.proof_validation_status":
...
func (x *fastReflection_Claim) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.Claim.proof_validation_status":
		panic(fmt.Errorf("field proof_validation_status of message poktroll.proof.Claim is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Claim"))
		}
...
func (x *Proof) GetProofRelay() []byte {
	if x != nil {
		return x.ProofRelay
	}
	return nil
...
var file_poktroll_proof_types_proto_rawDesc = []byte{
	...
	0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a, 0x05,
	...
	0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x5f, 0x72,
	0x65, 0x6c, 0x61, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x6f,
	0x66, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x22, 0x9c, 0x02, 0x0a, 0x05, 0x43, 0x6c, 0x61, 0x69, 0x6d,
	...
	,
