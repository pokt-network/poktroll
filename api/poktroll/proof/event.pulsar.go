...
func (x *fastReflection_EventProofValidityChecked) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.proof.EventProofValidityChecked.failure_reason":
...
func (x *fastReflection_EventProofValidityChecked) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.EventProofValidityChecked.failure_reason":
		panic(fmt.Errorf("field failure_reason of message poktroll.proof.EventProofValidityChecked is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.EventProofValidityChecked"))
		}
...
func init() {
	file_poktroll_proof_event_proto_init()
	md_EventParamsUpdated = File_poktroll_proof_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *EventParamsUpdated) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_proof_event_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.proof.EventParamsUpdated.params":
		return x.Params != nil
	case "poktroll.proof.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message poktroll.proof.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.proof.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message poktroll.proof.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.proof.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EventParamsUpdated) Descriptor() ([]byte, []int) {
	return file_poktroll_proof_event_proto_rawDescGZIP(), []int{5}
}
...
var file_poktroll_proof_event_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1a, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f,
	0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x1b, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x6f,
	0x66, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87,
	...
	0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42, 0x11, 0xea, 0xde, 0x1f, 0x0d, 0x63, 0x6c, 0x61,
	0x69, 0x6d, 0x65, 0x64, 0x5f, 0x75, 0x70, 0x6f, 0x6b, 0x74, 0x52, 0x0c, 0x63, 0x6c, 0x61, 0x69,
	0x6d, 0x65, 0x64, 0x55, 0x70, 0x6f, 0x6b, 0x74, 0x22, 0x9a, 0x02, 0x0a, 0x19, 0x45, 0x76, 0x65,
	...
	0x72, 0x6f, 0x6f, 0x66, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x39, 0x0a, 0x0e, 0x66, 0x61,
	0x69, 0x6c, 0x75, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x12, 0xea, 0xde, 0x1f, 0x0e, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x5f,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x0d, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xab, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x43, 0x0a, 0x06,
	...
	,
...
var file_poktroll_proof_event_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_poktroll_proof_event_proto_goTypes = []interface{}{
	...
	(*EventParamsUpdated)(nil),        // 5: poktroll.proof.EventParamsUpdated
	(*Claim)(nil),                     // 6: poktroll.proof.Claim
	(*v1beta1.Coin)(nil),              // 7: cosmos.base.v1beta1.Coin
	(*Proof)(nil),                     // 8: poktroll.proof.Proof
	(ClaimProofStatus)(0),             // 9: poktroll.proof.ClaimProofStatus
	(*Params)(nil),                    // 10: poktroll.proof.Params
}
var file_poktroll_proof_event_proto_depIdxs = []int32{
	6,  // 0: poktroll.proof.EventClaimCreated.claim:type_name -> poktroll.proof.Claim
	7,  // 1: poktroll.proof.EventClaimCreated.claimed_upokt:type_name -> cosmos.base.v1beta1.Coin
	6,  // 2: poktroll.proof.EventClaimUpdated.claim:type_name -> poktroll.proof.Claim
	7,  // 3: poktroll.proof.EventClaimUpdated.claimed_upokt:type_name -> cosmos.base.v1beta1.Coin
	6,  // 4: poktroll.proof.EventProofSubmitted.claim:type_name -> poktroll.proof.Claim
	8,  // 5: poktroll.proof.EventProofSubmitted.proof:type_name -> poktroll.proof.Proof
	7,  // 6: poktroll.proof.EventProofSubmitted.claimed_upokt:type_name -> cosmos.base.v1beta1.Coin
	6,  // 7: poktroll.proof.EventProofUpdated.claim:type_name -> poktroll.proof.Claim
	8,  // 8: poktroll.proof.EventProofUpdated.proof:type_name -> poktroll.proof.Proof
	7,  // 9: poktroll.proof.EventProofUpdated.claimed_upokt:type_name -> cosmos.base.v1beta1.Coin
	8,  // 10: poktroll.proof.EventProofValidityChecked.proof:type_name -> poktroll.proof.Proof
	9,  // 11: poktroll.proof.EventProofValidityChecked.proof_status:type_name -> poktroll.proof.ClaimProofStatus
	10, // 12: poktroll.proof.EventParamsUpdated.params:type_name -> poktroll.proof.Params
...
func file_poktroll_proof_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_poktroll_proof_event_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
