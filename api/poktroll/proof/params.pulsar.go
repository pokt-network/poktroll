...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ProofMissingPenalty != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ProofMissingPenalty)
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.proof.Params.proof_missing_penalty":
		return x.ProofMissingPenalty != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "poktroll.proof.Params.proof_missing_penalty":
		x.ProofMissingPenalty = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Params"))
		}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.proof.Params.proof_missing_penalty":
		x.ProofMissingPenalty = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.Params.proof_missing_penalty":
		panic(fmt.Errorf("field proof_missing_penalty of message poktroll.proof.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.Params"))
		}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.ProofMissingPenalty != 0 {
			n += 1 + runtime.Sov(uint64(x.ProofMissingPenalty))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.ProofMissingPenalty != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.ProofMissingPenalty))
			i--
			dAtA[i] = 0x20
		}
		if x.ProofRequirementThreshold != 0 {
		...
		for iNdEx < l {
			...
			case 4:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.ProofMissingPenalty |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type Params struct {
	...
	// but is not provided.
	ProofMissingPenalty uint64 `protobuf:"varint,4,opt,name=proof_missing_penalty,json=proofMissingPenalty,proto3" json:"proof_missing_penalty,omitempty"`
}
...
func (x *Params) GetProofMissingPenalty() uint64 {
	if x != nil {
...
var file_poktroll_proof_params_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	,
