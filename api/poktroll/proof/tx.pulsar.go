...
var (
	...
	fd_MsgCreateClaim_supplierAddress protoreflect.FieldDescriptor
	fd_MsgCreateClaim_sessionHeader   protoreflect.FieldDescriptor
	fd_MsgCreateClaim_rootHash        protoreflect.FieldDescriptor
)

func init() {
	file_poktroll_proof_tx_proto_init()
	md_MsgCreateClaim = File_poktroll_proof_tx_proto.Messages().ByName("MsgCreateClaim")
	fd_MsgCreateClaim_supplierAddress = md_MsgCreateClaim.Fields().ByName("supplierAddress")
	fd_MsgCreateClaim_sessionHeader = md_MsgCreateClaim.Fields().ByName("sessionHeader")
	fd_MsgCreateClaim_rootHash = md_MsgCreateClaim.Fields().ByName("rootHash")
}
...
func (x *fastReflection_MsgCreateClaim) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.SupplierAddress != "" {
		...
		if !f(fd_MsgCreateClaim_supplierAddress, value) {
			return
		}
	}
	if x.SessionHeader != "" {
		value := protoreflect.ValueOfString(x.SessionHeader)
		if !f(fd_MsgCreateClaim_sessionHeader, value) {
			return
		}
	}
	if x.RootHash != "" {
		value := protoreflect.ValueOfString(x.RootHash)
		if !f(fd_MsgCreateClaim_rootHash, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgCreateClaim) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.proof.MsgCreateClaim.supplierAddress":
		return x.SupplierAddress != ""
	case "poktroll.proof.MsgCreateClaim.sessionHeader":
		return x.SessionHeader != ""
	case "poktroll.proof.MsgCreateClaim.rootHash":
		return x.RootHash != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgCreateClaim) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.proof.MsgCreateClaim.supplierAddress":
		panic(fmt.Errorf("field supplierAddress of message poktroll.proof.MsgCreateClaim is not mutable"))
	case "poktroll.proof.MsgCreateClaim.sessionHeader":
		panic(fmt.Errorf("field sessionHeader of message poktroll.proof.MsgCreateClaim is not mutable"))
	case "poktroll.proof.MsgCreateClaim.rootHash":
		panic(fmt.Errorf("field rootHash of message poktroll.proof.MsgCreateClaim is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.MsgCreateClaim"))
		}
...
type MsgCreateClaim struct {
	...
	SupplierAddress string `protobuf:"bytes,1,opt,name=supplierAddress,proto3" json:"supplierAddress,omitempty"`
	SessionHeader   string `protobuf:"bytes,2,opt,name=sessionHeader,proto3" json:"sessionHeader,omitempty"`
...
func (x *MsgCreateClaim) GetSessionHeader() string {
	if x != nil {
		return x.SessionHeader
	}
	return ""
...
func (x *MsgCreateClaim) GetRootHash() string {
	if x != nil {
		return x.RootHash
	}
	return ""
...
var file_poktroll_proof_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f, 0x78, 0x2f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2f,
	...
	,
...
var file_poktroll_proof_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_poktroll_proof_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                  // 4: poktroll.proof.Params
}
var file_poktroll_proof_tx_proto_depIdxs = []int32{
	4, // 0: poktroll.proof.MsgUpdateParams.params:type_name -> poktroll.proof.Params
	0, // 1: poktroll.proof.Msg.UpdateParams:input_type -> poktroll.proof.MsgUpdateParams
	2, // 2: poktroll.proof.Msg.CreateClaim:input_type -> poktroll.proof.MsgCreateClaim
	1, // 3: poktroll.proof.Msg.UpdateParams:output_type -> poktroll.proof.MsgUpdateParamsResponse
	3, // 4: poktroll.proof.Msg.CreateClaim:output_type -> poktroll.proof.MsgCreateClaimResponse
