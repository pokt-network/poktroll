...
var (
	...
	fd_MsgUpdateParam_paramName protoreflect.FieldDescriptor
	fd_MsgUpdateParam_paramBz   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgUpdateParam_paramName = md_MsgUpdateParam.Fields().ByName("paramName")
	fd_MsgUpdateParam_paramBz = md_MsgUpdateParam.Fields().ByName("paramBz")
}
...
func (x *fastReflection_MsgUpdateParam) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ParamName != "" {
		value := protoreflect.ValueOfString(x.ParamName)
		if !f(fd_MsgUpdateParam_paramName, value) {
			return
		}
	}
	if x.ParamBz != "" {
		value := protoreflect.ValueOfString(x.ParamBz)
		if !f(fd_MsgUpdateParam_paramBz, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgUpdateParam) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.proof.MsgUpdateParam.authority":
		return x.Authority != ""
	case "poktroll.proof.MsgUpdateParam.paramName":
		return x.ParamName != ""
	case "poktroll.proof.MsgUpdateParam.paramBz":
		return x.ParamBz != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgUpdateParam) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.proof.MsgUpdateParam.authority":
		x.Authority = value.Interface().(string)
	case "poktroll.proof.MsgUpdateParam.paramName":
		x.ParamName = value.Interface().(string)
	case "poktroll.proof.MsgUpdateParam.paramBz":
		x.ParamBz = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.MsgUpdateParam"))
		}
...
func (x *fastReflection_MsgUpdateParam) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.proof.MsgUpdateParam.paramName":
		panic(fmt.Errorf("field paramName of message poktroll.proof.MsgUpdateParam is not mutable"))
	case "poktroll.proof.MsgUpdateParam.paramBz":
		panic(fmt.Errorf("field paramBz of message poktroll.proof.MsgUpdateParam is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.MsgUpdateParam"))
		}
...
func (x *fastReflection_MsgUpdateParam) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ParamBz) > 0 {
			i -= len(x.ParamBz)
			copy(dAtA[i:], x.ParamBz)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ParamBz)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.ParamName) > 0 {
			i -= len(x.ParamName)
			copy(dAtA[i:], x.ParamName)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ParamName)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.Authority) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ParamName", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ParamName = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ParamBz", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ParamBz = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *fastReflection_MsgUpdateParamResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.proof.MsgUpdateParamResponse.params":
		panic(fmt.Errorf("field params of message poktroll.proof.MsgUpdateParamResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.proof.MsgUpdateParamResponse"))
		}
...
type MsgUpdateParam struct {
	...
	ParamBz   string `protobuf:"bytes,3,opt,name=paramBz,proto3" json:"paramBz,omitempty"`
}
...
func (x *MsgUpdateParam) GetParamName() string {
	if x != nil {
		return x.ParamName
	}
	return ""
...
func (x *MsgUpdateParam) GetParamBz() string {
	if x != nil {
		return x.ParamBz
	}
	return ""
...
var file_poktroll_proof_tx_proto_rawDesc = []byte{
	...
	0x74, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x76,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x1c,
	0x0a, 0x09, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x42, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x42, 0x7a, 0x3a, 0x0e, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x61, 0x75, 0x74,
	...
	0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x32, 0xeb, 0x02, 0x0a, 0x03, 0x4d, 0x73, 0x67,
	0x12, 0x58, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	0x12, 0x1f, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x6f,
	0x66, 0x2e, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x1a, 0x27, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f,
	...
	,
	...
	0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1e, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f,
	0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2e, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x1a, 0x26, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f,
	0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2e, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a,
	0x05, 0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0x97, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x70,
...
var file_poktroll_proof_tx_proto_depIdxs = []int32{
	...
	6, // 6: poktroll.proof.Msg.UpdateParam:input_type -> poktroll.proof.MsgUpdateParam
	1, // 7: poktroll.proof.Msg.UpdateParams:output_type -> poktroll.proof.MsgUpdateParamsResponse
	3, // 8: poktroll.proof.Msg.CreateClaim:output_type -> poktroll.proof.MsgCreateClaimResponse
	5, // 9: poktroll.proof.Msg.SubmitProof:output_type -> poktroll.proof.MsgSubmitProofResponse
	7, // 10: poktroll.proof.Msg.UpdateParam:output_type -> poktroll.proof.MsgUpdateParamResponse
