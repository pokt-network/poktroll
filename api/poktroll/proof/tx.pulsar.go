...
var file_poktroll_proof_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_poktroll_proof_tx_proto_depIdxs = []int32{
	2, // 0: poktroll.proof.MsgUpdateParams.params:type_name -> poktroll.proof.Params
	0, // 1: poktroll.proof.Msg.UpdateParams:input_type -> poktroll.proof.MsgUpdateParams
	1, // 2: poktroll.proof.Msg.UpdateParams:output_type -> poktroll.proof.MsgUpdateParamsResponse
