...
var (
	...
	fd_Params_addServiceFee protoreflect.FieldDescriptor
)

func init() {
	file_poktroll_service_params_proto_init()
	md_Params = File_poktroll_service_params_proto.Messages().ByName("Params")
	fd_Params_addServiceFee = md_Params.Fields().ByName("addServiceFee")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AddServiceFee != uint64(0) {
		...
		if !f(fd_Params_addServiceFee, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.service.Params.addServiceFee":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.service.Params.addServiceFee":
		panic(fmt.Errorf("field addServiceFee of message poktroll.service.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.service.Params"))
		}
...
type Params struct {
	...
	AddServiceFee uint64 `protobuf:"varint,1,opt,name=addServiceFee,proto3" json:"addServiceFee,omitempty"`
}
...
var file_poktroll_service_params_proto_rawDesc = []byte{
	...
	,
