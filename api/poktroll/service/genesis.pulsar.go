...
var (
	...
	fd_GenesisState_serviceList protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_serviceList = md_GenesisState.Fields().ByName("serviceList")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ServiceList) != 0 {
		...
		if !f(fd_GenesisState_serviceList, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.service.GenesisState.params":
		return x.Params != nil
	case "poktroll.service.GenesisState.serviceList":
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.ServiceList = append(x.ServiceList, &Service{})
...
func (x *GenesisState) GetServiceList() []*Service {
	if x != nil {
...
var file_poktroll_service_genesis_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x01, 0x0a, 0x0c, 0x47,
	...
	0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x41, 0x0a, 0x0b, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0b,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x42, 0xa8, 0x01, 0x0a, 0x14,
...
var file_poktroll_service_genesis_proto_goTypes = []interface{}{
	...
	(*Service)(nil),      // 2: poktroll.service.Service
}
var file_poktroll_service_genesis_proto_depIdxs = []int32{
	...
	2, // 1: poktroll.service.GenesisState.serviceList:type_name -> poktroll.service.Service
