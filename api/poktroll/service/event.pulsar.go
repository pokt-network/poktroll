...
func init() {
	file_poktroll_service_event_proto_init()
	md_EventRelayMiningDifficultyUpdated = File_poktroll_service_event_proto.Messages().ByName("EventRelayMiningDifficultyUpdated")
...
func (x *EventRelayMiningDifficultyUpdated) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_service_event_proto_msgTypes[0]
...
func (x *fastReflection_EventRelayMiningDifficultyUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.service.EventRelayMiningDifficultyUpdated.service_id":
		return x.ServiceId != ""
	case "poktroll.service.EventRelayMiningDifficultyUpdated.prev_target_hash_hex_encoded":
		return x.PrevTargetHashHexEncoded != ""
	case "poktroll.service.EventRelayMiningDifficultyUpdated.new_target_hash_hex_encoded":
		return x.NewTargetHashHexEncoded != ""
	case "poktroll.service.EventRelayMiningDifficultyUpdated.prev_num_relays_ema":
		return x.PrevNumRelaysEma != uint64(0)
	case "poktroll.service.EventRelayMiningDifficultyUpdated.new_num_relays_ema":
		return x.NewNumRelaysEma != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.service.EventRelayMiningDifficultyUpdated"))
		}
		panic(fmt.Errorf("message poktroll.service.EventRelayMiningDifficultyUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventRelayMiningDifficultyUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.service.EventRelayMiningDifficultyUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventRelayMiningDifficultyUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "poktroll.service.EventRelayMiningDifficultyUpdated.service_id":
		panic(fmt.Errorf("field service_id of message poktroll.service.EventRelayMiningDifficultyUpdated is not mutable"))
	case "poktroll.service.EventRelayMiningDifficultyUpdated.prev_target_hash_hex_encoded":
		panic(fmt.Errorf("field prev_target_hash_hex_encoded of message poktroll.service.EventRelayMiningDifficultyUpdated is not mutable"))
	case "poktroll.service.EventRelayMiningDifficultyUpdated.new_target_hash_hex_encoded":
		panic(fmt.Errorf("field new_target_hash_hex_encoded of message poktroll.service.EventRelayMiningDifficultyUpdated is not mutable"))
	case "poktroll.service.EventRelayMiningDifficultyUpdated.prev_num_relays_ema":
		panic(fmt.Errorf("field prev_num_relays_ema of message poktroll.service.EventRelayMiningDifficultyUpdated is not mutable"))
	case "poktroll.service.EventRelayMiningDifficultyUpdated.new_num_relays_ema":
		panic(fmt.Errorf("field new_num_relays_ema of message poktroll.service.EventRelayMiningDifficultyUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.service.EventRelayMiningDifficultyUpdated"))
		}
...
func (x *fastReflection_EventRelayMiningDifficultyUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.service.EventRelayMiningDifficultyUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_poktroll_service_event_proto_init()
	md_EventParamsUpdated = File_poktroll_service_event_proto.Messages().ByName("EventParamsUpdated")
...
func (x *EventParamsUpdated) slowProtoReflect() protoreflect.Message {
	mi := &file_poktroll_service_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_EventParamsUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "poktroll.service.EventParamsUpdated.params":
		return x.Params != nil
	case "poktroll.service.EventParamsUpdated.effective_block_height":
		return x.EffectiveBlockHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.service.EventParamsUpdated"))
		}
		panic(fmt.Errorf("message poktroll.service.EventParamsUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message poktroll.service.EventParamsUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventParamsUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.service.EventParamsUpdated.effective_block_height":
		panic(fmt.Errorf("field effective_block_height of message poktroll.service.EventParamsUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.service.EventParamsUpdated"))
		}
...
func (x *fastReflection_EventParamsUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in poktroll.service.EventParamsUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EventRelayMiningDifficultyUpdated) Descriptor() ([]byte, []int) {
	return file_poktroll_service_event_proto_rawDescGZIP(), []int{0}
}
...
func (*EventParamsUpdated) Descriptor() ([]byte, []int) {
	return file_poktroll_service_event_proto_rawDescGZIP(), []int{1}
}
...
var File_poktroll_service_event_proto protoreflect.FileDescriptor

var file_poktroll_service_event_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10,
	...
	0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1d, 0x70, 0x6f, 0x6b, 0x74, 0x72,
	0x6f, 0x6c, 0x6c, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x02, 0x0a, 0x21, 0x45, 0x76, 0x65,
	...
	0x6c, 0x61, 0x79, 0x73, 0x45, 0x6d, 0x61, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x45,
	...
	0x65, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42, 0x13, 0xc8, 0xde, 0x1f, 0x00, 0xea, 0xde,
	...
	0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0xaa, 0x01, 0xd8, 0xe2, 0x1e, 0x01, 0x0a, 0x14,
	0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_poktroll_service_event_proto_rawDescOnce sync.Once
	file_poktroll_service_event_proto_rawDescData = file_poktroll_service_event_proto_rawDesc
)

func file_poktroll_service_event_proto_rawDescGZIP() []byte {
	file_poktroll_service_event_proto_rawDescOnce.Do(func() {
		file_poktroll_service_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_poktroll_service_event_proto_rawDescData)
	})
	return file_poktroll_service_event_proto_rawDescData
}

var file_poktroll_service_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_poktroll_service_event_proto_goTypes = []interface{}{
	(*EventRelayMiningDifficultyUpdated)(nil), // 0: poktroll.service.EventRelayMiningDifficultyUpdated
	(*EventParamsUpdated)(nil),                // 1: poktroll.service.EventParamsUpdated
	(*Params)(nil),                            // 2: poktroll.service.Params
}
var file_poktroll_service_event_proto_depIdxs = []int32{
	2, // 0: poktroll.service.EventParamsUpdated.params:type_name -> poktroll.service.Params
...
func init() { file_poktroll_service_event_proto_init() }
func file_poktroll_service_event_proto_init() {
	if File_poktroll_service_event_proto != nil {
		return
	}
	file_poktroll_service_params_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_poktroll_service_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_poktroll_service_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_poktroll_service_event_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_poktroll_service_event_proto_goTypes,
		DependencyIndexes: file_poktroll_service_event_proto_depIdxs,
		MessageInfos:      file_poktroll_service_event_proto_msgTypes,
	}.Build()
	File_poktroll_service_event_proto = out.File
	file_poktroll_service_event_proto_rawDesc = nil
	file_poktroll_service_event_proto_goTypes = nil
	file_poktroll_service_event_proto_depIdxs = nil
}
