...
var (
	...
	fd_EventApplicationOverserviced_supplier_addr    protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventApplicationOverserviced_supplier_addr = md_EventApplicationOverserviced.Fields().ByName("supplier_addr")
...
func (x *fastReflection_EventApplicationOverserviced) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SupplierAddr != "" {
		value := protoreflect.ValueOfString(x.SupplierAddr)
		if !f(fd_EventApplicationOverserviced_supplier_addr, value) {
			return
		}
	}
...
func (x *fastReflection_EventApplicationOverserviced) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.tokenomics.EventApplicationOverserviced.supplier_addr":
		return x.SupplierAddr != ""
...
func (x *fastReflection_EventApplicationOverserviced) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.tokenomics.EventApplicationOverserviced.supplier_addr":
		x.SupplierAddr = value.Interface().(string)
	case "poktroll.tokenomics.EventApplicationOverserviced.expected_burn":
...
func (x *fastReflection_EventApplicationOverserviced) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.tokenomics.EventApplicationOverserviced.supplier_addr":
		panic(fmt.Errorf("field supplier_addr of message poktroll.tokenomics.EventApplicationOverserviced is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.tokenomics.EventApplicationOverserviced"))
		}
...
func (x *fastReflection_EventApplicationOverserviced) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.SupplierAddr) > 0 {
			i -= len(x.SupplierAddr)
			copy(dAtA[i:], x.SupplierAddr)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SupplierAddr)))
			i--
			dAtA[i] = 0x12
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SupplierAddr", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SupplierAddr = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
func (x *EventApplicationOverserviced) GetSupplierAddr() string {
	if x != nil {
		return x.SupplierAddr
	}
	return ""
...
var file_poktroll_tokenomics_event_proto_rawDesc = []byte{
	...
	0x45, 0x6d, 0x61, 0x22, 0xf0, 0x01, 0x0a, 0x1c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x70, 0x70,
	...
	0x23, 0x0a, 0x0d, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72,
	...
	0x76, 0x65, 0x42, 0x75, 0x72, 0x6e, 0x22, 0xc2, 0x01, 0x0a, 0x24, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65,
	...
	0x4f, 0x4f, 0x46, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x10, 0x02, 0x42, 0xb8, 0x01,
	0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x6f, 0x6d, 0x69, 0x63, 0x73, 0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74,
...
var file_poktroll_tokenomics_event_proto_depIdxs = []int32{
	...
	8, // 6: poktroll.tokenomics.EventApplicationReimbursementRequest.amount:type_name -> cosmos.base.v1beta1.Coin
