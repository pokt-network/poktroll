...
func (x *_Application_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Application at list field ServiceConfigs as it is not of Message kind"))
}
...
var (
	...
	fd_Application_serviceConfigs            protoreflect.FieldDescriptor
	fd_Application_delegateeGatewayAddresses protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Application_serviceConfigs = md_Application.Fields().ByName("serviceConfigs")
	fd_Application_delegateeGatewayAddresses = md_Application.Fields().ByName("delegateeGatewayAddresses")
}
...
func (x *fastReflection_Application) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.application.Application.stake":
		return x.Stake != nil
	case "poktroll.application.Application.serviceConfigs":
		return len(x.ServiceConfigs) != 0
	case "poktroll.application.Application.delegateeGatewayAddresses":
...
func (x *fastReflection_Application) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ServiceConfigs) > 0 {
			for _, s := range x.ServiceConfigs {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ServiceConfigs) > 0 {
			for iNdEx := len(x.ServiceConfigs) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ServiceConfigs[iNdEx])
				copy(dAtA[i:], x.ServiceConfigs[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ServiceConfigs[iNdEx])))
				i--
				dAtA[i] = 0x1a
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.ServiceConfigs = append(x.ServiceConfigs, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
...
type Application struct {
	...
	ServiceConfigs            []string      `protobuf:"bytes,3,rep,name=serviceConfigs,proto3" json:"serviceConfigs,omitempty"`
	DelegateeGatewayAddresses []string      `protobuf:"bytes,4,rep,name=delegateeGatewayAddresses,proto3" json:"delegateeGatewayAddresses,omitempty"`
}
...
func (x *Application) GetServiceConfigs() []string {
	if x != nil {
...
var file_poktroll_application_application_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc4, 0x01, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61,
	...
	,
