...
var file_poktroll_application_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe4, 0x01, 0x0a, 0x03, 0x4d,
...
var file_poktroll_application_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_poktroll_application_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                      // 4: poktroll.application.Params
	(*v1beta1.Coin)(nil),                // 5: cosmos.base.v1beta1.Coin
}
var file_poktroll_application_tx_proto_depIdxs = []int32{
	4, // 0: poktroll.application.MsgUpdateParams.params:type_name -> poktroll.application.Params
	5, // 1: poktroll.application.MsgStakeApplication.stake:type_name -> cosmos.base.v1beta1.Coin
	...
	1, // 4: poktroll.application.Msg.UpdateParams:output_type -> poktroll.application.MsgUpdateParamsResponse
	3, // 5: poktroll.application.Msg.StakeApplication:output_type -> poktroll.application.MsgStakeApplicationResponse
