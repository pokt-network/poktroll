...
var file_poktroll_application_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_poktroll_application_tx_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                  // 2: poktroll.application.Params
}
var file_poktroll_application_tx_proto_depIdxs = []int32{
	2, // 0: poktroll.application.MsgUpdateParams.params:type_name -> poktroll.application.Params
	0, // 1: poktroll.application.Msg.UpdateParams:input_type -> poktroll.application.MsgUpdateParams
	1, // 2: poktroll.application.Msg.UpdateParams:output_type -> poktroll.application.MsgUpdateParamsResponse
