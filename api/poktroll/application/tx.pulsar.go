...
var (
	...
	fd_MsgUpdateParam_asType    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgUpdateParam_asType = md_MsgUpdateParam.Fields().ByName("asType")
}
...
func (x *fastReflection_MsgUpdateParam) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.AsType != "" {
		value := protoreflect.ValueOfString(x.AsType)
		if !f(fd_MsgUpdateParam_asType, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgUpdateParam) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.application.MsgUpdateParam.asType":
		x.AsType = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.application.MsgUpdateParam"))
		}
...
func (x *fastReflection_MsgUpdateParam) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.application.MsgUpdateParam.asType":
		panic(fmt.Errorf("field asType of message poktroll.application.MsgUpdateParam is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.application.MsgUpdateParam"))
		}
...
func (x *fastReflection_MsgUpdateParam) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AsType) > 0 {
			i -= len(x.AsType)
			copy(dAtA[i:], x.AsType)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AsType)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.Name) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AsType", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AsType = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *MsgUpdateParam) GetAsType() string {
	if x != nil {
		return x.AsType
	}
	return ""
...
var file_poktroll_application_tx_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x6a, 0x0a, 0x0e, 0x4d, 0x73, 0x67,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1c, 0x0a, 0x09, 0x61,
	...
	0x06, 0x61, 0x73, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61,
	0x73, 0x54, 0x79, 0x70, 0x65, 0x3a, 0x0e, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x61, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x30, 0x0a, 0x16, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
...
var file_poktroll_application_tx_proto_depIdxs = []int32{
	...
	12, // 10: poktroll.application.Msg.UpdateParam:input_type -> poktroll.application.MsgUpdateParam
	1,  // 11: poktroll.application.Msg.UpdateParams:output_type -> poktroll.application.MsgUpdateParamsResponse
	3,  // 12: poktroll.application.Msg.StakeApplication:output_type -> poktroll.application.MsgStakeApplicationResponse
	5,  // 13: poktroll.application.Msg.UnstakeApplication:output_type -> poktroll.application.MsgUnstakeApplicationResponse
	7,  // 14: poktroll.application.Msg.DelegateToGateway:output_type -> poktroll.application.MsgDelegateToGatewayResponse
	9,  // 15: poktroll.application.Msg.UndelegateFromGateway:output_type -> poktroll.application.MsgUndelegateFromGatewayResponse
	11, // 16: poktroll.application.Msg.TransferApplication:output_type -> poktroll.application.MsgTransferApplicationResponse
	13, // 17: poktroll.application.Msg.UpdateParam:output_type -> poktroll.application.MsgUpdateParamResponse
