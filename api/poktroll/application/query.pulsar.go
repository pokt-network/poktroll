...
var (
	...
	fd_QueryAllApplicationsRequest_gateway_address_delegated_to protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QueryAllApplicationsRequest_gateway_address_delegated_to = md_QueryAllApplicationsRequest.Fields().ByName("gateway_address_delegated_to")
}
...
func (x *fastReflection_QueryAllApplicationsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.GatewayAddressDelegatedTo != "" {
		value := protoreflect.ValueOfString(x.GatewayAddressDelegatedTo)
		if !f(fd_QueryAllApplicationsRequest_gateway_address_delegated_to, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryAllApplicationsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.application.QueryAllApplicationsRequest.gateway_address_delegated_to":
		return x.GatewayAddressDelegatedTo != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_QueryAllApplicationsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.application.QueryAllApplicationsRequest.pagination":
		...
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "poktroll.application.QueryAllApplicationsRequest.gateway_address_delegated_to":
		value := x.GatewayAddressDelegatedTo
		return protoreflect.ValueOfString(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.application.QueryAllApplicationsRequest"))
...
func (x *fastReflection_QueryAllApplicationsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "poktroll.application.QueryAllApplicationsRequest.gateway_address_delegated_to":
		x.GatewayAddressDelegatedTo = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.application.QueryAllApplicationsRequest"))
		}
...
func (x *fastReflection_QueryAllApplicationsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.application.QueryAllApplicationsRequest.gateway_address_delegated_to":
		panic(fmt.Errorf("field gateway_address_delegated_to of message poktroll.application.QueryAllApplicationsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.application.QueryAllApplicationsRequest"))
		}
...
func (x *fastReflection_QueryAllApplicationsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.GatewayAddressDelegatedTo)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.GatewayAddressDelegatedTo) > 0 {
			i -= len(x.GatewayAddressDelegatedTo)
			copy(dAtA[i:], x.GatewayAddressDelegatedTo)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.GatewayAddressDelegatedTo)))
			i--
			dAtA[i] = 0x12
		}
		if x.Pagination != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field GatewayAddressDelegatedTo", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.GatewayAddressDelegatedTo = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type QueryAllApplicationsRequest struct {
	...
	GatewayAddressDelegatedTo string `protobuf:"bytes,2,opt,name=gateway_address_delegated_to,json=gatewayAddressDelegatedTo,proto3" json:"gateway_address_delegated_to,omitempty"`
}
...
func (x *QueryAllApplicationsRequest) GetGatewayAddressDelegatedTo() string {
	if x != nil {
		return x.GatewayAddressDelegatedTo
	}
	return ""
...
var file_poktroll_application_query_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x0a, 0x1c, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x64, 0x65, 0x6c, 0x65,
	0x67, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x19,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x44, 0x65,
	0x6c, 0x65, 0x67, 0x61, 0x74, 0x65, 0x64, 0x54, 0x6f, 0x22, 0xb4, 0x01, 0x0a, 0x1c, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x0c, 0x61, 0x70,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0c, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x47, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e,
	...
	0x32, 0x84, 0x04, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x90, 0x01, 0x0a, 0x06, 0x50,
	...
	0x65, 0x73, 0x73, 0x7d, 0x12, 0xb0, 0x01, 0x0a, 0x0f, 0x41, 0x6c, 0x6c, 0x41, 0x70, 0x70, 0x6c,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x32, 0x2e, 0x70, 0x6f,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xc2, 0x01, 0xd8, 0xe2, 0x1e, 0x01, 0x0a, 0x18,
