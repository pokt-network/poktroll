...
var file_poktroll_gateway_query_proto_rawDesc = []byte{
	...
	0x73, 0x12, 0x24, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x67, 0x61, 0x74,
	...
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42, 0xa6, 0x01,
...
var file_poktroll_gateway_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_poktroll_gateway_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),              // 2: poktroll.gateway.Params
}
var file_poktroll_gateway_query_proto_depIdxs = []int32{
	2, // 0: poktroll.gateway.QueryParamsResponse.params:type_name -> poktroll.gateway.Params
	0, // 1: poktroll.gateway.Query.Params:input_type -> poktroll.gateway.QueryParamsRequest
	1, // 2: poktroll.gateway.Query.Params:output_type -> poktroll.gateway.QueryParamsResponse
