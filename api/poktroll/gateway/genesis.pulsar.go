...
var (
	...
	fd_GenesisState_gatewayList protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_gatewayList = md_GenesisState.Fields().ByName("gatewayList")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.GatewayList) != 0 {
		...
		if !f(fd_GenesisState_gatewayList, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "poktroll.gateway.GenesisState.params":
		return x.Params != nil
	case "poktroll.gateway.GenesisState.gatewayList":
...
type GenesisState struct {
	...
	GatewayList []*Gateway `protobuf:"bytes,2,rep,name=gatewayList,proto3" json:"gatewayList,omitempty"`
}
...
var file_poktroll_gateway_genesis_proto_rawDesc = []byte{
	...
	0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x01, 0x0a, 0x0c, 0x47,
	...
	0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x41, 0x0a, 0x0b, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0b,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x42, 0xa8, 0x01, 0x0a, 0x14,
	0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x67, 0x61, 0x74,
	0x65, 0x77, 0x61, 0x79, 0x42, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x50, 0x72, 0x6f,
...
var file_poktroll_gateway_genesis_proto_depIdxs = []int32{
	...
	2, // 1: poktroll.gateway.GenesisState.gatewayList:type_name -> poktroll.gateway.Gateway
