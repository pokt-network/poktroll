...
var file_poktroll_gateway_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_poktroll_gateway_tx_proto_depIdxs = []int32{
	2, // 0: poktroll.gateway.MsgUpdateParams.params:type_name -> poktroll.gateway.Params
	0, // 1: poktroll.gateway.Msg.UpdateParams:input_type -> poktroll.gateway.MsgUpdateParams
	1, // 2: poktroll.gateway.Msg.UpdateParams:output_type -> poktroll.gateway.MsgUpdateParamsResponse
