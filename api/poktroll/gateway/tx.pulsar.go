...
var (
	...
	fd_MsgUpdateParam_as_type   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgUpdateParam_as_type = md_MsgUpdateParam.Fields().ByName("as_type")
}
...
func (x *fastReflection_MsgUpdateParam) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.AsType != "" {
		...
		if !f(fd_MsgUpdateParam_as_type, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgUpdateParam) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "poktroll.gateway.MsgUpdateParam.as_type":
		panic(fmt.Errorf("field as_type of message poktroll.gateway.MsgUpdateParam is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: poktroll.gateway.MsgUpdateParam"))
		}
...
var file_poktroll_gateway_tx_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x85, 0x01,
	...
	0x61, 0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61,
	0x73, 0x54, 0x79, 0x70, 0x65, 0x3a, 0x0e, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x61, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x4a, 0x0a, 0x16, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61,
	...
	0x18, 0x2e, 0x70, 0x6f, 0x6b, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x32, 0x87, 0x03, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x5c, 0x0a, 0x0c, 0x55, 0x70, 0x64,
...
var file_poktroll_gateway_tx_proto_depIdxs = []int32{
	...
	8,  // 3: poktroll.gateway.MsgUpdateParamResponse.params:type_name -> poktroll.gateway.Params
	0,  // 4: poktroll.gateway.Msg.UpdateParams:input_type -> poktroll.gateway.MsgUpdateParams
	2,  // 5: poktroll.gateway.Msg.StakeGateway:input_type -> poktroll.gateway.MsgStakeGateway
	4,  // 6: poktroll.gateway.Msg.UnstakeGateway:input_type -> poktroll.gateway.MsgUnstakeGateway
	6,  // 7: poktroll.gateway.Msg.UpdateParam:input_type -> poktroll.gateway.MsgUpdateParam
	1,  // 8: poktroll.gateway.Msg.UpdateParams:output_type -> poktroll.gateway.MsgUpdateParamsResponse
	3,  // 9: poktroll.gateway.Msg.StakeGateway:output_type -> poktroll.gateway.MsgStakeGatewayResponse
	5,  // 10: poktroll.gateway.Msg.UnstakeGateway:output_type -> poktroll.gateway.MsgUnstakeGatewayResponse
	7,  // 11: poktroll.gateway.Msg.UpdateParam:output_type -> poktroll.gateway.MsgUpdateParamResponse
