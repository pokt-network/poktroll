...
import { QueryParamsResponse } from "./types/pocket/session/query";
import { QueryGetSessionResponse } from "./types/pocket/session/query";

import { QueryParamsRequest } from "./types/pocket/session/query";
import { QueryGetSessionRequest } from "./types/pocket/session/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/session/params
   */
  queryParams = (
   ...
   * @request GET:/pokt-network/poktroll/session/get_session
   */
  queryGetSession = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetSessionRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetSessionResponse>>>({
