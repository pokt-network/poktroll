...
import { QueryParamsResponse } from "./types/pocket/gateway/query";
import { QueryGetGatewayResponse } from "./types/pocket/gateway/query";
import { QueryAllGatewaysResponse } from "./types/pocket/gateway/query";

import { QueryParamsRequest } from "./types/pocket/gateway/query";
import { QueryGetGatewayRequest } from "./types/pocket/gateway/query";
import { QueryAllGatewaysRequest } from "./types/pocket/gateway/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/gateway/params
   */
  queryParams = (
   ...
   * @tags Query
   * @name queryGateway
   * @request GET:/pokt-network/poktroll/gateway/gateway/{address}
   */
  queryGateway = (address: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetGatewayResponse>>>({
   ...
   *
   * @tags Query
   * @name queryAllGateways
   * @request GET:/pokt-network/poktroll/gateway/gateway
   */
  queryAllGateways = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllGatewaysRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllGatewaysResponse>>>({
