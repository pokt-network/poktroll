...
import { QueryParamsResponse } from "./types/pocket/supplier/query";
import { QueryGetSupplierResponse } from "./types/pocket/supplier/query";
import { QueryAllSuppliersResponse } from "./types/pocket/supplier/query";

import { QueryParamsRequest } from "./types/pocket/supplier/query";
import { QueryGetSupplierRequest } from "./types/pocket/supplier/query";
import { QueryAllSuppliersRequest } from "./types/pocket/supplier/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/supplier/params
   */
  queryParams = (
   ...
   * @tags Query
   * @name querySupplier
   * @request GET:/pokt-network/poktroll/supplier/supplier/{operator_address}
   */
  querySupplier = (operator_address: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetSupplierRequest>>>,"operator_address">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetSupplierResponse>>>({
   ...
   * @request GET:/pokt-network/poktroll/supplier/supplier
   */
  queryAllSuppliers = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllSuppliersRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllSuppliersResponse>>>({
