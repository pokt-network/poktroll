...
import { QueryParamsResponse } from "./types/pocket/application/query";
import { QueryGetApplicationResponse } from "./types/pocket/application/query";
import { QueryAllApplicationsResponse } from "./types/pocket/application/query";

import { QueryParamsRequest } from "./types/pocket/application/query";
import { QueryGetApplicationRequest } from "./types/pocket/application/query";
import { QueryAllApplicationsRequest } from "./types/pocket/application/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/application/params
   */
  queryParams = (
   ...
   * @request GET:/pokt-network/poktroll/application/application/{address}
   */
  queryApplication = (address: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetApplicationResponse>>>({
   ...
   *
   * @tags Query
   * @name queryAllApplications
   * @request GET:/pokt-network/poktroll/application/application
   */
  queryAllApplications = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllApplicationsRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllApplicationsResponse>>>({
