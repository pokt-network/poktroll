...
import { QueryParamsResponse } from "./types/pocket/shared/query";

import { QueryParamsRequest } from "./types/pocket/shared/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/shared/params
   */
  queryParams = (
