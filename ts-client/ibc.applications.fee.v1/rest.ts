...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryIncentivizedPackets = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketsRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketsResponse>>>({
   ...
   */
  queryIncentivizedPacket = (packet_id.channel_id: string, packet_id.port_id: string, packet_id.sequence: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketRequest>>>,"packet_id.channel_id" | "packet_id.port_id" | "packet_id.sequence">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketResponse>>>({
   ...
   */
  queryIncentivizedPacketsForChannel = (channel_id: string, port_id: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketsForChannelRequest>>>,"channel_id" | "port_id">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryIncentivizedPacketsForChannelResponse>>>({
   ...
   */
  queryTotalRecvFees = (packet_id.channel_id: string, packet_id.port_id: string, packet_id.sequence: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalRecvFeesRequest>>>,"packet_id.channel_id" | "packet_id.port_id" | "packet_id.sequence">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalRecvFeesResponse>>>({
   ...
   */
  queryTotalAckFees = (packet_id.channel_id: string, packet_id.port_id: string, packet_id.sequence: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalAckFeesRequest>>>,"packet_id.channel_id" | "packet_id.port_id" | "packet_id.sequence">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalAckFeesResponse>>>({
   ...
   */
  queryTotalTimeoutFees = (packet_id.channel_id: string, packet_id.port_id: string, packet_id.sequence: string,
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalTimeoutFeesRequest>>>,"packet_id.channel_id" | "packet_id.port_id" | "packet_id.sequence">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryTotalTimeoutFeesResponse>>>({
   ...
   */
  queryPayee = (channel_id: string, relayer: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryPayeeResponse>>>({
   ...
   */
  queryCounterpartyPayee = (channel_id: string, relayer: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryCounterpartyPayeeResponse>>>({
   ...
   */
  queryFeeEnabledChannels = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryFeeEnabledChannelsRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryFeeEnabledChannelsResponse>>>({
   ...
   */
  queryFeeEnabledChannel = (channel_id: string, port_id: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryFeeEnabledChannelResponse>>>({
