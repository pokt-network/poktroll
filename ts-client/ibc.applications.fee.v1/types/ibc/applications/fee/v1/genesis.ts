...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.feeEnabledChannels) {
      FeeEnabledChannel.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.registeredPayees) {
      RegisteredPayee.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.registeredCounterpartyPayees) {
      RegisteredCounterpartyPayee.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.forwardRelayers) {
      ForwardRelayerAddress.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const FeeEnabledChannel: MessageFns<FeeEnabledChannel> = {
  encode(message: FeeEnabledChannel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
...
export const RegisteredPayee: MessageFns<RegisteredPayee> = {
  encode(message: RegisteredPayee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.channelId !== "") {
...
export const RegisteredCounterpartyPayee: MessageFns<RegisteredCounterpartyPayee> = {
  encode(message: RegisteredCounterpartyPayee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.channelId !== "") {
      writer.uint32(10).string(message.channelId);
    }
    if (message.relayer !== "") {
...
export const ForwardRelayerAddress: MessageFns<ForwardRelayerAddress> = {
  encode(message: ForwardRelayerAddress, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.packetId !== undefined) {
      PacketId.encode(message.packetId, writer.uint32(18).fork()).join();
    }
    return writer;
  },
