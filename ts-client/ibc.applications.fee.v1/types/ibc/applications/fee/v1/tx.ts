...
export const MsgRegisterPayee: MessageFns<MsgRegisterPayee> = {
  encode(message: MsgRegisterPayee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
...
export const MsgRegisterPayeeResponse: MessageFns<MsgRegisterPayeeResponse> = {
  encode(_: MsgRegisterPayeeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgRegisterCounterpartyPayee: MessageFns<MsgRegisterCounterpartyPayee> = {
  encode(message: MsgRegisterCounterpartyPayee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.portId !== "") {
      writer.uint32(10).string(message.portId);
    }
    if (message.channelId !== "") {
...
export const MsgRegisterCounterpartyPayeeResponse: MessageFns<MsgRegisterCounterpartyPayeeResponse> = {
  encode(_: MsgRegisterCounterpartyPayeeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgPayPacketFee: MessageFns<MsgPayPacketFee> = {
  encode(message: MsgPayPacketFee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const MsgPayPacketFeeResponse: MessageFns<MsgPayPacketFeeResponse> = {
  encode(_: MsgPayPacketFeeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgPayPacketFeeAsync: MessageFns<MsgPayPacketFeeAsync> = {
  encode(message: MsgPayPacketFeeAsync, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.packetId !== undefined) {
      PacketId.encode(message.packetId, writer.uint32(10).fork()).join();
    }
    if (message.packetFee !== undefined) {
      PacketFee.encode(message.packetFee, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const MsgPayPacketFeeAsyncResponse: MessageFns<MsgPayPacketFeeAsyncResponse> = {
  encode(_: MsgPayPacketFeeAsyncResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
