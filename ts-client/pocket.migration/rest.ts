...
import { QueryParamsResponse } from "./types/pocket/migration/query";
import { QueryMorseClaimableAccountResponse } from "./types/pocket/migration/query";
import { QueryAllMorseClaimableAccountResponse } from "./types/pocket/migration/query";

import { QueryParamsRequest } from "./types/pocket/migration/query";
import { QueryMorseClaimableAccountRequest } from "./types/pocket/migration/query";
import { QueryAllMorseClaimableAccountRequest } from "./types/pocket/migration/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/pokt-network/poktroll/migration/params
   */
  queryParams = (
   ...
   *
   * @tags Query
   * @name queryMorseClaimableAccount
   * @request GET:/pokt-network/poktroll/migration/morse_claimable_account/{address}
   */
  queryMorseClaimableAccount = (address: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryMorseClaimableAccountResponse>>>({
   ...
   *
   * @tags Query
   * @name queryMorseClaimableAccountAll
   * @request GET:/pokt-network/poktroll/migration/morse_claimable_account
   */
  queryMorseClaimableAccountAll = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllMorseClaimableAccountRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllMorseClaimableAccountResponse>>>({
