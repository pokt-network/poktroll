...
func ImportMorseAccountsCmd() *cobra.Command {
	importMorseAcctsCmd := &cobra.Command{
		...
		Short: "Import the Morse accounts contained within the Morse accounts import message JSON file",
		Long: `Import the Morse accounts contained within the Morse accounts import message JSON file.
