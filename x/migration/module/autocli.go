		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					// TODO_MAINNET_MIGRATION(@bryanchriswhite, #1034): Implement CLI logic.
					Skip: true, // skipped because authority gated
				},
				{
					...
					// TODO_MAINNET_MIGRATION(@bryanchriswhite, #1034): Add morse account claiming CLI, incl. examples (see x/supplier/module/autocli.go).
				},
				{
					...
					Skip:           true, // skipped because autoCLI cannot handle loading & signing using the Morse key.
					// TODO_MAINNET_MIGRATION(@bryanchriswhite, #1034): Add morse application claiming CLI, incl. examples (see x/supplier/module/autocli.go).
				},
				{
