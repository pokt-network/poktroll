...
type MsgClaimMorseAccount struct {
	...
	MorsePublicKey crypto_ed25519.PublicKey `protobuf:"bytes,3,opt,name=morse_public_key,json=morsePublicKey,proto3,casttype=crypto/ed25519.PublicKey" json:"morse_public_key,omitempty"`
...
type MsgClaimMorseSupplier struct {
	...
	MorseSignature []byte `protobuf:"bytes,5,opt,name=morse_signature,json=morseSignature,proto3" json:"morse_signature"`
	// The services this supplier is staked to provide service for.
	Services []*types1.SupplierServiceConfig `protobuf:"bytes,6,rep,name=services,proto3" json:"services"`
}
...
var fileDescriptor_e5cfeb615ae29ee6 = []byte{
	...
	,
}
