...
type MsgClaimMorseSupplier struct {
	...
	MorseSignerPublicKey github_com_cometbft_cometbft_crypto_ed25519.PubKey `protobuf:"bytes,7,opt,name=morse_signer_public_key,json=morseSignerPublicKey,proto3,casttype=github.com/cometbft/cometbft/crypto/ed25519.PubKey" json:"morse_signer_public_key"`
	// TODO_IN_THIS_COMMIT: update...
	// The hex-encoded address of the Morse account whose balance will be claimed.
	// E.g.: 00f9900606fa3d5c9179fc0c8513078a53a2073e
...
func (m *MsgClaimMorseSupplier) GetMorseSignerPublicKey() github_com_cometbft_cometbft_crypto_ed25519.PubKey {
	if m != nil {
		return m.MorseSignerPublicKey
	}
	return nil
}

func (m *MsgClaimMorseSupplier) GetMorseOperatorAddress() string {
	if m != nil {
...
type MsgClaimMorseSupplierResponse struct {
	...
	// E.g.: 00f9900606fa3d5c9179fc0c8513078a53a2073e
	MorseOperatorAddress string `protobuf:"bytes,1,opt,name=morse_operator_address,json=morseOperatorAddress,proto3" json:"morse_operator_address"`
	// TODO_IN_THIS_COMMIT: update...
	// TODO_IN_THIS_COMMIT: use in msg handler!
	MorseSingerAddress string `protobuf:"bytes,8,opt,name=morse_singer_address,json=morseSingerAddress,proto3" json:"morse_singer_address"`
...
func (m *MsgClaimMorseSupplierResponse) GetMorseOperatorAddress() string {
	if m != nil {
		return m.MorseOperatorAddress
	}
	return ""
...
func (m *MsgClaimMorseSupplierResponse) GetMorseSingerAddress() string {
	if m != nil {
...
var fileDescriptor_e5cfeb615ae29ee6 = []byte{
	...
	,
}
...
func (m *MsgClaimMorseSupplier) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MorseSignerPublicKey) > 0 {
		i -= len(m.MorseSignerPublicKey)
		copy(dAtA[i:], m.MorseSignerPublicKey)
		i = encodeVarintTx(dAtA, i, uint64(len(m.MorseSignerPublicKey)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ShannonSigningAddress) > 0 {
	...
	if len(m.MorseOperatorAddress) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.MorseOperatorAddress)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *MsgClaimMorseSupplierResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MorseSingerAddress) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.MorseSingerAddress)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *MsgClaimMorseSupplier) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MorseSignerPublicKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MorseSignerPublicKey = append(m.MorseSignerPublicKey[:0], dAtA[iNdEx:postIndex]...)
			if m.MorseSignerPublicKey == nil {
				m.MorseSignerPublicKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
