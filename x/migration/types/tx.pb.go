...
func (m *MsgImportMorseClaimableAccounts) GetMorseAccountState() string {
	if m != nil {
...
var fileDescriptor_21658240592266b6 = []byte{
	...
	,
	...
	0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x20, 0xbb, 0x74, 0xf3, 0x52, 0x4b,
	0xca, 0xf3, 0x8b, 0xb2, 0xf5, 0xb1, 0x26, 0x92, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70,
	0x2a, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xca, 0x33, 0x83, 0xe7, 0x96, 0x03, 0x00, 0x00,
}
...
func (m *MsgImportMorseClaimableAccounts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MorseAccountState) > 0 {
		i -= len(m.MorseAccountState)
		copy(dAtA[i:], m.MorseAccountState)
		i = encodeVarintTx(dAtA, i, uint64(len(m.MorseAccountState)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Authority) > 0 {
...
func (m *MsgImportMorseClaimableAccounts) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.MorseAccountState = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
