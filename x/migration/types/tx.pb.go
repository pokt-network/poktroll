...
type MsgClaimMorseAccount struct {
	...
	MorsePublicKey crypto_ed25519.PublicKey `protobuf:"bytes,4,opt,name=morse_public_key,json=morsePublicKey,proto3,casttype=crypto/ed25519.PublicKey" json:"morse_public_key,omitempty"`
...
func (m *MsgClaimMorseAccount) GetMorsePublicKey() crypto_ed25519.PublicKey {
	if m != nil {
...
type MsgClaimMorseApplication struct {
	...
	MorseSrcAddress string `protobuf:"bytes,2,opt,name=morse_src_address,json=morseSrcAddress,proto3" json:"morse_src_address"`
	// The ed25519 public key of the morse account with morse_src_address.
	MorsePublicKey crypto_ed25519.PublicKey `protobuf:"bytes,5,opt,name=morse_public_key,json=morsePublicKey,proto3,casttype=crypto/ed25519.PublicKey" json:"morse_public_key,omitempty"`
	// The hex-encoded signature, by the Morse account, of this message (where this field is nil).
	// I.e.: morse_signature = private_key.sign(marshal(MsgClaimMorseAccount{morse_signature: nil, ...}))
	MorseSignature []byte `protobuf:"bytes,3,opt,name=morse_signature,json=morseSignature,proto3" json:"morse_signature"`
...
func (m *MsgClaimMorseApplication) GetMorsePublicKey() crypto_ed25519.PublicKey {
	if m != nil {
		return m.MorsePublicKey
	}
	return nil
...
type MsgClaimMorseSupplier struct {
	...
	// account/actor claim message fee waiving; the tx contains ONE OR MORE Morse account/actor
	// claim messages AND has EXACTLY ONE signer.
	ShannonSigningAddress string `protobuf:"bytes,7,opt,name=shannon_signing_address,json=shannonSigningAddress,proto3" json:"shannon_signing_address"`
	// The bech32-encoded address of the Shannon account to which the claimed tokens
	...
	// The ed25519 public key of the morse account with morse_src_address.
	MorsePublicKey crypto_ed25519.PublicKey `protobuf:"bytes,6,opt,name=morse_public_key,json=morsePublicKey,proto3,casttype=crypto/ed25519.PublicKey" json:"morse_public_key,omitempty"`
	// The hex-encoded address of the Morse account whose balance will be claimed.
	// E.g.: 00f9900606fa3d5c9179fc0c8513078a53a2073e
	//
...
func (m *MsgClaimMorseSupplier) GetMorsePublicKey() crypto_ed25519.PublicKey {
	if m != nil {
		return m.MorsePublicKey
	}
	return nil
...
var fileDescriptor_e5cfeb615ae29ee6 = []byte{
	...
	,
}
