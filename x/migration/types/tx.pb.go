...
import (
	...
	types3 "github.com/pokt-network/poktroll/x/gateway/types"
...
func (m *MsgClaimMorseGateway) GetMorseSignature() []byte {
	if m != nil {
		return m.MorseSignature
	}
	return nil
...
type MsgClaimMorseGatewayResponse struct {
	...
	ClaimedGatewayStake types.Coin `protobuf:"bytes,4,opt,name=claimed_gateway_stake,json=claimedGatewayStake,proto3" json:"claimed_gateway_stake"`
	// The height (on Shannon) at which the claim was created.
	ClaimedAtHeight int64 `protobuf:"varint,5,opt,name=claimedAtHeight,proto3" json:"claimed_at_height"`
	// The gateway which was staked as a result of the claim.
	Gateway *types3.Gateway `protobuf:"bytes,6,opt,name=gateway,proto3" json:"gateway"`
}
...
func (m *MsgClaimMorseGatewayResponse) GetClaimedGatewayStake() types.Coin {
	if m != nil {
		return m.ClaimedGatewayStake
	}
	return types.Coin{}
}

func (m *MsgClaimMorseGatewayResponse) GetClaimedAtHeight() int64 {
	if m != nil {
		return m.ClaimedAtHeight
	}
	return 0
...
func (m *MsgClaimMorseGatewayResponse) GetGateway() *types3.Gateway {
	if m != nil {
		return m.Gateway
	}
	return nil
...
var fileDescriptor_21658240592266b6 = []byte{
	...
	,
}
...
func (m *MsgClaimMorseGatewayResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size, err := m.ClaimedGatewayStake.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgClaimMorseGatewayResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClaimedGatewayStake", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ClaimedGatewayStake.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
