...
type EventClaimSettled struct {
	...
	// the number of estimated compute units and the compute uints to token multiplier.
	ClaimedUpokt *types1.Coin `protobuf:"bytes,6,opt,name=claimed_upokt,json=claimedUpokt,proto3" json:"claimed_upokt"`
	SettledUpokt *types1.Coin `protobuf:"bytes,7,opt,name=settled_upokt,json=settledUpokt,proto3" json:"settled_upokt"`
}
...
func (m *EventClaimSettled) GetSettledUpokt() *types1.Coin {
	if m != nil {
...
var fileDescriptor_a78874bbf91a58c7 = []byte{
	...
	,
}
...
func (m *EventClaimSettled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SettledUpokt != nil {
		{
			size, err := m.SettledUpokt.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EventClaimSettled) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.SettledUpokt == nil {
				m.SettledUpokt = &types1.Coin{}
			}
			if err := m.SettledUpokt.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
