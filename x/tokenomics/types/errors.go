...
var (
	...
	ErrTokenomicsModuleBurn                            = sdkerrors.Register(ModuleName, 1109, "failed to burn uPOKT from application module account")
	...
	ErrTokenomicsModuleMint                            = sdkerrors.Register(ModuleName, 1122, "failed to mint uPOKT to supplier module account")
	ErrTokenomicsTransfer                              = sdkerrors.Register(ModuleName, 1123, "failed to send coins")
	...
	ErrTokenomicsCalculation                           = sdkerrors.Register(ModuleName, 1130, "tokenomics calculation error")
	ErrTokenomicsApplicationModuleSendFailed           = sdkerrors.Register(ModuleName, 1131, "failed to send uPOKT from application module account")
)
