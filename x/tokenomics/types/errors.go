...
var (
	...
	ErrTokenomicsSupplierNotFound             = sdkerrors.Register(ModuleName, 1108, "supplier not found")
	ErrTokenomicsApplicationNotFound          = sdkerrors.Register(ModuleName, 1109, "application not found")
	ErrTokenomicsApplicationModuleBurn        = sdkerrors.Register(ModuleName, 1112, "failed to burn uPOKT from application module account")
	...
	ErrTokenomicsApplicationNewStakeInvalid   = sdkerrors.Register(ModuleName, 1116, "application stake cannot be reduced to a -ve amount")
	ErrTokenomicsParamNameInvalid             = sdkerrors.Register(ModuleName, 1117, "the provided param name is invalid")
	ErrTokenomicsParamInvalid                 = sdkerrors.Register(ModuleName, 1118, "the provided param is invalid")
	ErrTokenomicsUnmarshalInvalid             = sdkerrors.Register(ModuleName, 1119, "failed to unmarshal the provided bytes")
