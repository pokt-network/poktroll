...
var (
	...
	ErrTokenomicsSupplierOperatorAddressInvalid = sdkerrors.Register(ModuleName, 1107, "the supplier operator address in the claim is not a valid bech32 address")
	...
	ErrTokenomicsSupplierNotFound               = sdkerrors.Register(ModuleName, 1125, "supplier not found")
)
