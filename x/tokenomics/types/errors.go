...
var (
	...
	ErrTokenomicsSupplierRevShareFailed         = sdkerrors.Register(ModuleName, 1121, "failed to send rev share to supplier shareholders")
	ErrTokenomicsAmountMismatchTooLarge         = sdkerrors.Register(ModuleName, 1122, "an unexpected amount mismatch occurred")
	ErrTokenomicsMintAmountZero                 = sdkerrors.Register(ModuleName, 1123, "mint amount cannot be zero")
	ErrTokenomicsTLMError                       = sdkerrors.Register(ModuleName, 1124, "failed to process TLM")
	ErrTokenomicsRewardDistributionFailed       = sdkerrors.Register(ModuleName, 1125, "failed to distribute rewards")
)
