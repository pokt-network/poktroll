...
type MsgUpdateParam_AsDouble struct {
	AsDouble float64 `protobuf:"fixed64,3,opt,name=as_double,json=asDouble,proto3,oneof" json:"as_double"`
}
...
func (m *MsgUpdateParam) GetAsDouble() float64 {
	if x, ok := m.GetAsType().(*MsgUpdateParam_AsDouble); ok {
		return x.AsDouble
	}
	return 0
}
...
var fileDescriptor_aa0f2fdbd9b6d7eb = []byte{
	...
	,
}
...
func (m *MsgUpdateParam_AsDouble) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgUpdateParam_AsDouble) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
...
func (m *MsgUpdateParam_AsDouble) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgUpdateParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			iNdEx += 8
			m.AsType = &MsgUpdateParam_AsDouble{float64(math.Float64frombits(v))}
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
			if err != nil {
