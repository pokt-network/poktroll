...
type SharedKeeper interface {
	...
	// Used to compute an application's unbonding end height with the session length that was
	// in effect when it began unbonding, so a later num_blocks_per_session decrease cannot
