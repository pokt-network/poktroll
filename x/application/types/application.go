...
func GetApplicationUnbondingHeight(
	...
	sharedParamsUpdate := sharedtypes.GetEffectiveParamsUpdate(sharedParamsUpdates, unstakeSessionEndHeight)
...
func GetApplicationTransferHeight(
	...
	sharedParamsUpdate := sharedtypes.GetEffectiveParamsUpdate(sharedParamsUpdates, pendingTransferSessionEndHeight)
