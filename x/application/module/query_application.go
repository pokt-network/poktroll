...
Example:
$ pocketd q application list-application --network <network> --home $(POCKETD_HOME)`,
...
Example:
$ pocketd q application show-application $(APP_ADDRESS) --network <network> --home $(POCKETD_HOME)`,
