...
func TestCLI_DelegateToGateway(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			// appAddress:     appBech32.Address.String(),
			gatewayAddress: gatewayBech32,
		...
		},
		{
			...
			appAddress: appBech32,
			// gatewayAddress: gatewayBech32.Address.String(),
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			...
			// Execute the command
			delegateOutput, err := testcli.ExecTestCLICmd(ctx, cli.CmdDelegateToGateway(), args)
