...
// SetParams stores the shared parameters
...
func (k Keeper) GetParamsUpdates(ctx context.Context) types.ParamsHistory {
	...
	// Sort updates chronologically by activation height
