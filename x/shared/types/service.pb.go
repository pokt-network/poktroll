...
type Service struct {
	...
	// Optional metadata containing an API specification for the service.
...
type Metadata struct {
	ApiSpecs []byte `protobuf:"bytes,1,opt,name=api_specs,json=apiSpecs,proto3" json:"api_specs,omitempty"`
}
...
func (m *Metadata) GetApiSpecs() []byte {
	if m != nil {
		return m.ApiSpecs
	}
	return nil
...
var fileDescriptor_4dfdeb4ae793ca69 = []byte{
	...
	,
}
...
func (m *Metadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ApiSpecs) > 0 {
		i -= len(m.ApiSpecs)
		copy(dAtA[i:], m.ApiSpecs)
		i = encodeVarintService(dAtA, i, uint64(len(m.ApiSpecs)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ApiSpecs = append(m.ApiSpecs[:0], dAtA[iNdEx:postIndex]...)
			if m.ApiSpecs == nil {
				m.ApiSpecs = []byte{}
			}
			iNdEx = postIndex
