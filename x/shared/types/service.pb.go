...
type Service struct {
	...
	// total_relays tracks the cumulative (monotonically increasing) onchain usage
	// of this service since its creation.
	TotalRelays uint64 `protobuf:"varint,5,opt,name=total_relays,json=totalRelays,proto3" json:"total_relays,omitempty"`
	// total_compute_units tracks the cumulative (monotonically increasing) onchain
	// compute units consumption of this service since its creation.
	TotalComputeUnits uint64 `protobuf:"varint,6,opt,name=total_compute_units,json=totalComputeUnits,proto3" json:"total_compute_units,omitempty"`
}
...
func (m *Service) GetTotalRelays() uint64 {
	if m != nil {
		return m.TotalRelays
	}
	return 0
}

func (m *Service) GetTotalComputeUnits() uint64 {
	if m != nil {
		return m.TotalComputeUnits
	}
	return 0
}
...
func (m *ServiceUsageMetrics) Reset()         { *m = ServiceUsageMetrics{} }
func (m *ServiceUsageMetrics) String() string { return proto.CompactTextString(m) }
...
func (m *ServiceUsageMetrics) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ServiceUsageMetrics) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ServiceUsageMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceUsageMetrics.Merge(m, src)
}
func (m *ServiceUsageMetrics) XXX_Size() int {
	return m.Size()
}
func (m *ServiceUsageMetrics) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceUsageMetrics.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceUsageMetrics proto.InternalMessageInfo

func (m *ServiceUsageMetrics) GetServiceId() string {
	if m != nil {
		return m.ServiceId
	}
	return ""
...
func (m *ServiceUsageMetrics) GetTotalRelays() uint64 {
	if m != nil {
		return m.TotalRelays
	}
	return 0
...
func (m *ServiceUsageMetrics) GetTotalComputeUnits() uint64 {
	if m != nil {
		return m.TotalComputeUnits
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ServiceUsageMetrics)(nil), "pocket.shared.ServiceUsageMetrics")
}
...
var fileDescriptor_4dfdeb4ae793ca69 = []byte{
	...
	,
}
...
func (m *Service) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TotalComputeUnits != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.TotalComputeUnits))
		i--
		dAtA[i] = 0x30
	}
	if m.TotalRelays != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.TotalRelays))
		i--
		dAtA[i] = 0x28
	}
...
func (m *ServiceUsageMetrics) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ServiceUsageMetrics) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ServiceUsageMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Service) Size() (n int) {
	...
	if m.TotalRelays != 0 {
		n += 1 + sovService(uint64(m.TotalRelays))
	}
	if m.TotalComputeUnits != 0 {
		n += 1 + sovService(uint64(m.TotalComputeUnits))
	}
	return n
}
...
func (m *ServiceUsageMetrics) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Service) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalRelays", wireType)
			}
			m.TotalRelays = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalRelays |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalComputeUnits", wireType)
			}
			m.TotalComputeUnits = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalComputeUnits |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ServiceUsageMetrics) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceUsageMetrics: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceUsageMetrics: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
