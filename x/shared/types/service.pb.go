...
type SupplierServiceConfig struct {
	...
	RevShare  []*ServiceRevShare  `protobuf:"bytes,3,rep,name=rev_share,json=revShare,proto3" json:"rev_share,omitempty"`
}
...
func (m *SupplierServiceConfig) GetRevShare() []*ServiceRevShare {
	if m != nil {
		return m.RevShare
	}
	return nil
...
func (m *ServiceRevShare) Reset()         { *m = ServiceRevShare{} }
func (m *ServiceRevShare) String() string { return proto.CompactTextString(m) }
func (*ServiceRevShare) ProtoMessage()    {}
func (*ServiceRevShare) Descriptor() ([]byte, []int) {
	return fileDescriptor_302c2f793a11ae1e, []int{4}
}
func (m *ServiceRevShare) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ServiceRevShare) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ServiceRevShare.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ServiceRevShare) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceRevShare.Merge(m, src)
}
func (m *ServiceRevShare) XXX_Size() int {
	return m.Size()
}
func (m *ServiceRevShare) XXX_DiscardUnknown() {
	xxx_messageInfo_ServiceRevShare.DiscardUnknown(m)
}

var xxx_messageInfo_ServiceRevShare proto.InternalMessageInfo

func (m *ServiceRevShare) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *ServiceRevShare) GetRevSharePercentage() float32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ServiceRevShare)(nil), "poktroll.shared.ServiceRevShare")
...
var fileDescriptor_302c2f793a11ae1e = []byte{
	...
	,
}
...
func (m *ServiceRevShare) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ServiceRevShare) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ServiceRevShare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ServiceRevShare) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SupplierServiceConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RevShare = append(m.RevShare, &ServiceRevShare{})
...
func (m *ServiceRevShare) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceRevShare: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceRevShare: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
