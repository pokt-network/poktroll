...
type Params struct {
	...
	ComputeUnitsToTokenMultiplier uint64 `protobuf:"varint,9,opt,name=compute_units_to_token_multiplier,json=computeUnitsToTokenMultiplier,proto3" json:"compute_units_to_token_multiplier" yaml:"compute_units_to_token_multiplier"`
...
func (m *Params) GetComputeUnitsToTokenMultiplier() uint64 {
	if m != nil {
		return m.ComputeUnitsToTokenMultiplier
	}
	return 0
}
...
var fileDescriptor_2903b40318a5dde0 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.ComputeUnitsToTokenMultiplier != that1.ComputeUnitsToTokenMultiplier {
		return false
	}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ComputeUnitsToTokenMultiplier != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.ComputeUnitsToTokenMultiplier))
		i--
		dAtA[i] = 0x48
	}
...
func (m *Params) Size() (n int) {
	...
	if m.ComputeUnitsToTokenMultiplier != 0 {
		n += 1 + sovParams(uint64(m.ComputeUnitsToTokenMultiplier))
	}
	if m.GatewayUnbondingPeriodSessions != 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComputeUnitsToTokenMultiplier", wireType)
			}
			m.ComputeUnitsToTokenMultiplier = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ComputeUnitsToTokenMultiplier |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
