...
func (k Keeper) SetService(ctx context.Context, service sharedtypes.Service) {
	...
	k.servicesCache.Set(service.Id, service)
}
...
func (k Keeper) GetService(
	...
	if service, found := k.servicesCache.Get(serviceId); found {
	...
	k.servicesCache.Set(serviceId, service)
	return service, true
}
...
func (k Keeper) RemoveService(
	...
	k.servicesCache.Delete(serviceId)
}
