...
func TestMsgServer_SubmitProof_Success(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			getProofMsgHeight: func(sharedParamsUpdates []*sharedtypes.ParamsUpdate, queryHeight int64, supplierOperatorAddr string) int64 {
		...
		},
		{
			...
			getProofMsgHeight: func(sharedParamsUpdates []*sharedtypes.ParamsUpdate, queryHeight int64, _ string) int64 {
