...
type QueryAllSuppliersRequest struct {
	...
	//	*QueryAllSuppliersRequest_OwnerAddress
...
type QueryAllSuppliersRequest_OwnerAddress struct {
...
func (*QueryAllSuppliersRequest_OwnerAddress) isQueryAllSuppliersRequest_Filter() {}
...
func (m *QueryAllSuppliersRequest) GetOwnerAddress() string {
	if x, ok := m.GetFilter().(*QueryAllSuppliersRequest_OwnerAddress); ok {
...
func (*QueryAllSuppliersRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*QueryAllSuppliersRequest_OwnerAddress)(nil),
	}
}
...
var fileDescriptor_9ddacf5456729a55 = []byte{
	...
	,
}
...
func (m *QueryAllSuppliersRequest_OwnerAddress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllSuppliersRequest_OwnerAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *QueryAllSuppliersRequest_OwnerAddress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllSuppliersRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Filter = &QueryAllSuppliersRequest_OwnerAddress{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
