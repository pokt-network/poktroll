...
| ------------- | -------------------- | ----- |
| Alpha TestNet | [${alpha_height:-⚪}](${alpha_height_url:-⚪}) | $([ "${alpha_block}" ] && echo "🟢" || echo "⚪") |
| Beta TestNet  | [${beta_height:-⚪}](${beta_height_url:-⚪}) | $([ "${beta_block}" ] && echo "🟢" || echo "⚪") |
| MainNet       | [${main_height:-⚪}](${main_height_url:-⚪}) | $([ "${main_block}" ] && echo "🟢" || echo "⚪") |
