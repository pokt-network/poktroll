...
// TODO_INVESTIGATE: Test disabled due to CGO changes - https://github.com/pokt-network/poktroll/discussions/1822
// This test validates the relayminer relay CLI command which depends on stdout JSON output that was disabled
