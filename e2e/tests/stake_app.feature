Feature: Stake App Namespaces
    ...
    Scenario: User can stake an Application waiting for it to unbond
        ...
        When the user stakes a "application" with "100000070" uPOKT for "anvil" service from the account "app4"
        ...
        And the "application" for account "app4" is staked with "100000070" uPOKT
        And the account balance of "app4" should be "100000070" uPOKT "less" than before
    ...
    Scenario: User can unstake an Application
        ...
        And the user verifies the "application" for account "app4" is not staked
        And the account balance of "app4" should be "100000070" uPOKT "more" than before