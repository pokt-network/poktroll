...
func BaseClaim(appAddr, supplierAddr string, sum uint64) proof.Claim {
	return proof.Claim{
...
// selection.
func ClaimWithRandomHash(t *testing.T, appAddr, supplierAddr string, sum uint64) proof.Claim {
