...
//
// DEV_NOTE: This was increased from 50 to 10_000 to prevent "missing supplier operator signature" errors during high load.
...
const defaultPublishBufferSize = 10_000
