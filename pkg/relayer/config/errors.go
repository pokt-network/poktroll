...
var (
	...
	ErrRelayerMinerWrongForwardToken         = sdkerrors.Register(codespace, 2108, "wrong or empty forward.token in configuration file. Expect a 32 bytes hexadecimal string (you can use 'make relayminer_forward_token_gen' command to generate a token)")
)
