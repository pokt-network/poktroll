...
var (
	...
	ErrSessionTreeUndefinedStoresDirectoryPath = sdkerrors.Register(codespace, 5, "session tree key-value store directory undefined for where they will be saved on disk")
