...
func (sym *symmetricServer) newRelayRequest(request *http.Request) (*types.RelayRequest, error) {
...
func (sym *symmetricServer) newRelayResponse(
	...
	if err = sym.relayerProxy.SignRelayResponse(relayResponse); err != nil {
		return nil, err
	}
