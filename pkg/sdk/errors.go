...
var (
	...
	ErrSDKInvalidConfig                 = sdkerrors.Register(codespace, 5, "invalid SDK configuration")
	ErrSDKInvalidSession                = sdkerrors.Register(codespace, 6, "error fetching session")
)
